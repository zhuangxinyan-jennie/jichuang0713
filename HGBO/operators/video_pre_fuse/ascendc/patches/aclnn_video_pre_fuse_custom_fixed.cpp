...
TensorDesc inputDesc0_0[1] = {{ge::DT_FLOAT16, ge::FORMAT_ND}};
    ...
    aclOpExecutor **executor)
{
    ...
    static NnopbaseDfxId tilingId = {0x60000, "aclnnVideoPreFuseCustomTiling", false};
    void *nnopExecutor;
    static void *executorSpace = NULL;
    const char *opType = "VideoPreFuseCustom";
    char inputDesc[] = {1};
    char outputDesc[] = {1};
    char attrDesc[] = {};
