...
def _build_lhs_init_params(basic: OpTuneBasic, n_startup_trials: int) -> Dict[str, Any]:
...
def run_dse(basic: OpTuneBasic, seed: int = 12345, fresh: bool = False) -> optuna.Study:
    ...
    if basic.alg == "tpe_lhs":
        ...
        lhs_params = _build_lhs_init_params(basic, n_startup_trials)
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--operator",
        required=True,
        choices=["video_pre_fuse", "keypoint_post_process"],
