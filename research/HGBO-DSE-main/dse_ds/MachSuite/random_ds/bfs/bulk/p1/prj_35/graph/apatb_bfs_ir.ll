...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* nonnull %2, [128 x i8]* nonnull align 512 %level_copy_0, [128 x i8]* nonnull align 512 %level_copy_1, [10 x i64]* nonnull %3, [5 x i64]* nonnull align 512 %level_counts_copy_0, [5 x i64]* nonnull align 512 %level_counts_copy_1)
  ...
  %6 = getelementptr [2048 x i64], [2048 x i64]* %edges_copy_0, i32 0, i32 0
  %7 = getelementptr [2048 x i64], [2048 x i64]* %edges_copy_1, i32 0, i32 0
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i64* %6, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i64* %7, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  ...
  call void @apatb_bfs_hw([128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, i64 %starting_node, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [5 x i64]* %level_counts_copy_0, [5 x i64]* %level_counts_copy_1)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* %2, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [10 x i64]* %3, [5 x i64]* %level_counts_copy_0, [5 x i64]* %level_counts_copy_1)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.5.6([2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [128 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias readonly "orig.arg.no"="4", [128 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_03, [128 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_14, [10 x i64]* noalias readonly "orig.arg.no"="6", [5 x i64]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_05, [5 x i64]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_16) #4 {
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.3.4([128 x i128]* %_0, [128 x i128]* %_1, [256 x %struct.node_t_struct]* %0)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.5.6([2048 x i64]* %_01, [2048 x i64]* %_12, [4096 x %struct.edge_t_struct]* %1)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.17.18([4096 x %struct.edge_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias "orig.arg.no"="4", [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_03, [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_14, [10 x i64]* noalias "orig.arg.no"="6", [5 x i64]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_05, [5 x i64]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_16) #5 {
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.15.16([256 x %struct.node_t_struct]* %0, [128 x i128]* %_0, [128 x i128]* %_1)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.17.18([4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %_01, [2048 x i64]* %_12)
...
declare void @apatb_bfs_hw([128 x i128]*, [128 x i128]*, [2048 x i64]*, [2048 x i64]*, i64, [128 x i8]*, [128 x i8]*, [5 x i64]*, [5 x i64]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias "orig.arg.no"="4", [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_03, [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_14, [10 x i64]* noalias "orig.arg.no"="6", [5 x i64]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_05, [5 x i64]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_16) #5 {
entry:
  call void @onebyonecpy_hls.p0a256i8.19.20([256 x i8]* %2, [128 x i8]* align 512 %_03, [128 x i8]* align 512 %_14)
  call void @onebyonecpy_hls.p0a10i64.21.22([10 x i64]* %3, [5 x i64]* align 512 %_05, [5 x i64]* align 512 %_16)
  ret void
...
define void @bfs_hw_stub_wrapper([128 x i128]*, [128 x i128]*, [2048 x i64]*, [2048 x i64]*, i64, [128 x i8]*, [128 x i8]*, [5 x i64]*, [5 x i64]*) #6 {
entry:
  ...
  %11 = alloca [256 x i8]
  %12 = alloca [10 x i64]
  call void @copy_out([256 x %struct.node_t_struct]* %9, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %10, [2048 x i64]* %2, [2048 x i64]* %3, [256 x i8]* %11, [128 x i8]* %5, [128 x i8]* %6, [10 x i64]* %12, [5 x i64]* %7, [5 x i64]* %8)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %9, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %10, [2048 x i64]* %2, [2048 x i64]* %3, [256 x i8]* %11, [128 x i8]* %5, [128 x i8]* %6, [10 x i64]* %12, [5 x i64]* %7, [5 x i64]* %8)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_35.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
