...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i128]* %edges_copy2, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy3, [10 x i64]* nonnull %3, [5 x i128]* nonnull align 512 %level_counts_copy4)
  ...
  call void @apatb_bfs_hw(i128* %4, [2048 x i128]* %edges_copy2, i64 %starting_node, [128 x i16]* %level_copy3, [5 x i128]* %level_counts_copy4)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [2048 x i128]* %edges_copy2, [256 x i8]* %2, [128 x i16]* %level_copy3, [10 x i64]* %3, [5 x i128]* %level_counts_copy4)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0a256struct.node_t_struct.6([256 x %struct.node_t_struct]* noalias, [256 x i128]* noalias readonly) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.12([2048 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [4096 x %struct.edge_t_struct]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.19.20([128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.21.22([5 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [10 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [256 x i128]* noalias "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [2048 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias readonly "orig.arg.no"="4", [128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias readonly "orig.arg.no"="6", [5 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7") #3 {
entry:
  call fastcc void @onebyonecpy_hls.p0a256struct.node_t_struct([256 x i128]* %1, [256 x %struct.node_t_struct]* %0)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.12([2048 x i128]* %3, [4096 x %struct.edge_t_struct]* %2)
  call void @onebyonecpy_hls.p0a256i8.19.20([128 x i16]* align 512 %5, [256 x i8]* %4)
  call void @onebyonecpy_hls.p0a10i64.21.22([5 x i128]* align 512 %7, [10 x i64]* %6)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.29.30([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.31.32([10 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [256 x i128]* noalias readonly "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7") #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a256struct.node_t_struct.6([256 x %struct.node_t_struct]* %0, [256 x i128]* %1)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct([4096 x %struct.edge_t_struct]* %2, [2048 x i128]* %3)
  call void @onebyonecpy_hls.p0a256i8.29.30([256 x i8]* %4, [128 x i16]* align 512 %5)
  call void @onebyonecpy_hls.p0a10i64.31.32([10 x i64]* %6, [5 x i128]* align 512 %7)
  ret void
}

declare void @apatb_bfs_hw(i128*, [2048 x i128]*, i64, [128 x i16]*, [5 x i128]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [256 x i128]* noalias readonly "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7") #4 {
entry:
  call void @onebyonecpy_hls.p0a256i8.29.30([256 x i8]* %4, [128 x i16]* align 512 %5)
  call void @onebyonecpy_hls.p0a10i64.31.32([10 x i64]* %6, [5 x i128]* align 512 %7)
  ret void
...
define void @bfs_hw_stub_wrapper(i128*, [2048 x i128]*, i64, [128 x i16]*, [5 x i128]*) #5 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %5, [256 x i128]* %9, [4096 x %struct.edge_t_struct]* %6, [2048 x i128]* %1, [256 x i8]* %7, [128 x i16]* %3, [10 x i64]* %8, [5 x i128]* %4)
  %10 = bitcast [256 x %struct.node_t_struct]* %5 to %struct.node_t_struct*
  %11 = bitcast [4096 x %struct.edge_t_struct]* %6 to %struct.edge_t_struct*
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %5, [256 x i128]* %9, [4096 x %struct.edge_t_struct]* %6, [2048 x i128]* %1, [256 x i8]* %7, [128 x i16]* %3, [10 x i64]* %8, [5 x i128]* %4)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_49.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
