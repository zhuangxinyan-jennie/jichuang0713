...
entry:
  ...
  %level_copy8 = alloca [128 x i16], align 512
  %level_counts_copy_09 = alloca [3 x i128], align 512
  %level_counts_copy_110 = alloca [3 x i128], align 512
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy8, [10 x i64]* nonnull %3, [3 x i128]* nonnull align 512 %level_counts_copy_09, [3 x i128]* nonnull align 512 %level_counts_copy_110)
  ...
  %level_copy.gep11 = getelementptr [128 x i16], [128 x i16]* %level_copy8, i64 0, i32 0
  %level_counts_copy.gep_012 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_09, i64 0, i32 0
  %level_counts_copy.gep_113 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_110, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep11, i32 0, i32 1, i32 0) ], !dbg !41
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %level_counts_copy.gep_012, i32 0, i32 1, i32 0, i1 false) ], !dbg !42
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %level_counts_copy.gep_113, i32 0, i32 1, i32 0, i1 false) ], !dbg !42
  call void @apatb_bfs_hw([64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, i64 %starting_node, [128 x i16]* %level_copy8, [3 x i128]* %level_counts_copy_09, [3 x i128]* %level_counts_copy_110)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, [256 x i8]* %2, [128 x i16]* %level_copy8, [10 x i64]* %3, [3 x i128]* %level_counts_copy_09, [3 x i128]* %level_counts_copy_110)
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep_012, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep_113, i32 0, i32 1, i32 0) ]
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.45.46([128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [64 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [1024 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [1024 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias readonly "orig.arg.no"="4", [128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias readonly "orig.arg.no"="6", [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #4 {
entry:
  ...
  call void @onebyonecpy_hls.p0a256i8.45.46([128 x i16]* align 512 %3, [256 x i8]* %2)
  call void @onebyonecpy_hls.p0a10i64.7.8([3 x i128]* align 512 %_03, [3 x i128]* align 512 %_14, [10 x i64]* %4)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.13.14([256 x %struct.node_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.57.58([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias "orig.arg.no"="4", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #5 {
entry:
  ...
  call void @onebyonecpy_hls.p0a256i8.57.58([256 x i8]* %2, [128 x i16]* align 512 %3)
  call void @onebyonecpy_hls.p0a10i64.17.18([10 x i64]* %4, [3 x i128]* align 512 %_03, [3 x i128]* align 512 %_14)
  ret void
}

declare void @apatb_bfs_hw([64 x i256]*, [64 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i16]*, [3 x i128]*, [3 x i128]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias "orig.arg.no"="4", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #5 {
entry:
  call void @onebyonecpy_hls.p0a256i8.57.58([256 x i8]* %2, [128 x i16]* align 512 %3)
  call void @onebyonecpy_hls.p0a10i64.17.18([10 x i64]* %4, [3 x i128]* align 512 %_03, [3 x i128]* align 512 %_14)
  ret void
...
define void @bfs_hw_stub_wrapper([64 x i256]*, [64 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i16]*, [3 x i128]*, [3 x i128]*) #6 {
entry:
  ...
  %10 = alloca [256 x i8]
  %11 = alloca [10 x i64]
  call void @copy_out([256 x %struct.node_t_struct]* %8, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %9, [1024 x i128]* %2, [1024 x i128]* %3, [256 x i8]* %10, [128 x i16]* %5, [10 x i64]* %11, [3 x i128]* %6, [3 x i128]* %7)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %8, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %9, [1024 x i128]* %2, [1024 x i128]* %3, [256 x i8]* %10, [128 x i16]* %5, [10 x i64]* %11, [3 x i128]* %6, [3 x i128]* %7)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_14.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
