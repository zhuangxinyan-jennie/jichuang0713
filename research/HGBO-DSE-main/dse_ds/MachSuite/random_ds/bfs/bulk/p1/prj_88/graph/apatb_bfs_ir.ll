...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* nonnull %1, [4096 x i64]* %edges_copy, [256 x i8]* nonnull %2, [128 x i8]* nonnull align 512 %level_copy_0, [128 x i8]* nonnull align 512 %level_copy_1, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i8* %level_copy.gep_0, i32 0, i32 1, i32 0, i1 false) ], !dbg !5
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i8* %level_copy.gep_1, i32 0, i32 1, i32 0, i1 false) ], !dbg !5
  call void @apatb_bfs_hw(i128* %4, i64* %5, i64 %starting_node, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, i64* %6)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [4096 x i64]* %edges_copy, [256 x i8]* %2, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [256 x i128]* noalias "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [4096 x i64]* noalias "orig.arg.no"="3", [256 x i8]* noalias readonly "orig.arg.no"="4", [128 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_0, [128 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_1, [10 x i64]* noalias readonly "orig.arg.no"="6", [10 x i64]* noalias align 512 "orig.arg.no"="7") #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a256struct.node_t_struct.22([256 x i128]* %1, [256 x %struct.node_t_struct]* %0)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [256 x i128]* noalias readonly "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [4096 x i64]* noalias readonly "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_0, [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_1, [10 x i64]* noalias "orig.arg.no"="6", [10 x i64]* noalias readonly align 512 "orig.arg.no"="7") #5 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0a256struct.node_t_struct.22([256 x i128]* noalias, [256 x %struct.node_t_struct]* noalias readonly) unnamed_addr #2 {
entry:
...
declare void @apatb_bfs_hw(i128*, i64*, i64, [128 x i8]*, [128 x i8]*, i64*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [256 x i128]* noalias readonly "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [4096 x i64]* noalias readonly "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_0, [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_1, [10 x i64]* noalias "orig.arg.no"="6", [10 x i64]* noalias readonly align 512 "orig.arg.no"="7") #5 {
entry:
  call void @onebyonecpy_hls.p0a256i8.9.10([256 x i8]* %4, [128 x i8]* align 512 %_0, [128 x i8]* align 512 %_1)
  call fastcc void @onebyonecpy_hls.p0a10i64([10 x i64]* %5, [10 x i64]* align 512 %6)
  ret void
...
define void @bfs_hw_stub_wrapper(i128*, i64*, i64, [128 x i8]*, [128 x i8]*, i64*) #6 {
entry:
  ...
  %11 = bitcast i64* %5 to [10 x i64]*
  call void @copy_out([256 x %struct.node_t_struct]* %6, [256 x i128]* %9, [4096 x %struct.edge_t_struct]* %7, [4096 x i64]* %10, [256 x i8]* %8, [128 x i8]* %3, [128 x i8]* %4, [10 x i64]* null, [10 x i64]* %11)
  %12 = bitcast [256 x %struct.node_t_struct]* %6 to %struct.node_t_struct*
  %13 = bitcast [4096 x %struct.edge_t_struct]* %7 to %struct.edge_t_struct*
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [256 x i128]* %9, [4096 x %struct.edge_t_struct]* %7, [4096 x i64]* %10, [256 x i8]* %8, [128 x i8]* %3, [128 x i8]* %4, [10 x i64]* null, [10 x i64]* %11)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_88.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
