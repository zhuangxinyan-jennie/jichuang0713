...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, [4096 x %struct.edge_t_struct]* nonnull %1, [4096 x i64]* %edges_copy, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy4, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  call void @apatb_bfs_hw([64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, i64* %6, i64 %starting_node, [128 x i16]* %level_copy4, i64* %7)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, [4096 x %struct.edge_t_struct]* %1, [4096 x i64]* %edges_copy, [256 x i8]* %2, [128 x i16]* %level_copy4, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.9.10([256 x %struct.node_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #2 {
entry:
...
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.9.10([256 x %struct.node_t_struct]* %0, [64 x i256]* %_0, [64 x i256]* %_1)
...
declare void @apatb_bfs_hw([64 x i256]*, [64 x i256]*, i64*, i64, [128 x i16]*, i64*)
...
define void @bfs_hw_stub_wrapper([64 x i256]*, [64 x i256]*, i64*, i64, [128 x i16]*, i64*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %6, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %7, [4096 x i64]* %9, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* null, [10 x i64]* %10)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %7, [4096 x i64]* %9, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* null, [10 x i64]* %10)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_68.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
