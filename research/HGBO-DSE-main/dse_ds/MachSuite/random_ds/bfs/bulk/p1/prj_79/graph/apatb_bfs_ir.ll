...
entry:
  ...
  %level_counts_copy_04 = alloca [3 x i128], align 512
  %level_counts_copy_15 = alloca [3 x i128], align 512
  ...
  %level_counts_copy.gep_06 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_04, i64 0, i32 0
  %level_counts_copy.gep_17 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_15, i64 0, i32 0
  ...
  call void @apatb_bfs_hw([128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, i64 %starting_node, i8* %8, [3 x i128]* %level_counts_copy_04, [3 x i128]* %level_counts_copy_15)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [3 x i128]* %level_counts_copy_04, [3 x i128]* %level_counts_copy_15)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [128 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias readonly "orig.arg.no"="4", [256 x i8]* noalias align 512 "orig.arg.no"="5", [10 x i64]* noalias readonly "orig.arg.no"="6", [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #4 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias "orig.arg.no"="4", [256 x i8]* noalias readonly align 512 "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #5 {
entry:
...
declare void @apatb_bfs_hw([128 x i128]*, [128 x i128]*, [2048 x i64]*, [2048 x i64]*, i64, i8*, [3 x i128]*, [3 x i128]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias "orig.arg.no"="4", [256 x i8]* noalias readonly align 512 "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #5 {
entry:
  call fastcc void @onebyonecpy_hls.p0a256i8([256 x i8]* %2, [256 x i8]* align 512 %3)
  call void @onebyonecpy_hls.p0a10i64.17.18([10 x i64]* %4, [3 x i128]* align 512 %_03, [3 x i128]* align 512 %_14)
  ret void
...
define void @bfs_hw_stub_wrapper([128 x i128]*, [128 x i128]*, [2048 x i64]*, [2048 x i64]*, i64, i8*, [3 x i128]*, [3 x i128]*) #6 {
entry:
  ...
  %10 = alloca [10 x i64]
  %11 = bitcast i8* %5 to [256 x i8]*
  call void @copy_out([256 x %struct.node_t_struct]* %8, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %9, [2048 x i64]* %2, [2048 x i64]* %3, [256 x i8]* null, [256 x i8]* %11, [10 x i64]* %10, [3 x i128]* %6, [3 x i128]* %7)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %8, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %9, [2048 x i64]* %2, [2048 x i64]* %3, [256 x i8]* null, [256 x i8]* %11, [10 x i64]* %10, [3 x i128]* %6, [3 x i128]* %7)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_79.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
