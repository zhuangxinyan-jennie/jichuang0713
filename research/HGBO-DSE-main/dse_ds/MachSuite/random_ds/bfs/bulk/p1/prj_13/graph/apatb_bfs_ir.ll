...
entry:
  ...
  %level_copy.gep_07 = getelementptr [64 x i16], [64 x i16]* %level_copy_04, i64 0, i32 0
  %level_copy.gep_18 = getelementptr [64 x i16], [64 x i16]* %level_copy_15, i64 0, i32 0
  %level_counts_copy.gep9 = getelementptr [5 x i128], [5 x i128]* %level_counts_copy6, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %level_copy.gep_07, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %level_copy.gep_18, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep9, i32 0, i32 1, i32 0) ], !dbg !41
  call void @apatb_bfs_hw([64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, i64* %6, i64 %starting_node, [64 x i16]* %level_copy_04, [64 x i16]* %level_copy_15, [5 x i128]* %level_counts_copy6)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, [4096 x %struct.edge_t_struct]* %1, [4096 x i64]* %edges_copy, [256 x i8]* %2, [64 x i16]* %level_copy_04, [64 x i16]* %level_copy_15, [10 x i64]* %3, [5 x i128]* %level_counts_copy6)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.38.39([5 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [10 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.48.49([10 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
declare void @apatb_bfs_hw([64 x i256]*, [64 x i256]*, i64*, i64, [64 x i16]*, [64 x i16]*, [5 x i128]*)
...
define void @bfs_hw_stub_wrapper([64 x i256]*, [64 x i256]*, i64*, i64, [64 x i16]*, [64 x i16]*, [5 x i128]*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %7, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %8, [4096 x i64]* %11, [256 x i8]* %9, [64 x i16]* %4, [64 x i16]* %5, [10 x i64]* %10, [5 x i128]* %6)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %8, [4096 x i64]* %11, [256 x i8]* %9, [64 x i16]* %4, [64 x i16]* %5, [10 x i64]* %10, [5 x i128]* %6)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_13.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
