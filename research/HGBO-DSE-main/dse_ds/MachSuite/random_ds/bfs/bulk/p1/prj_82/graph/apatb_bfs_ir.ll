...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_03, [1024 x i128]* %edges_copy_14, [256 x i8]* nonnull %2, [256 x i8]* nonnull align 512 %level_copy, [10 x i64]* nonnull %3, [5 x i128]* nonnull align 512 %level_counts_copy5)
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep6, i32 0, i32 1, i32 0) ], !dbg !41
  call void @apatb_bfs_hw([128 x i256]* %nodes_copy2, [1024 x i128]* %edges_copy_03, [1024 x i128]* %edges_copy_14, i64 %starting_node, i8* %7, [5 x i128]* %level_counts_copy5)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_03, [1024 x i128]* %edges_copy_14, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [5 x i128]* %level_counts_copy5)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct([128 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x %struct.node_t_struct]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.34.35([5 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [10 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.15([256 x %struct.node_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.44.45([10 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
declare void @apatb_bfs_hw([128 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, i8*, [5 x i128]*)
...
define void @bfs_hw_stub_wrapper([128 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, i8*, [5 x i128]*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %6, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %7, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* %8, [5 x i128]* %5)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %7, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* %8, [5 x i128]* %5)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_82.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
