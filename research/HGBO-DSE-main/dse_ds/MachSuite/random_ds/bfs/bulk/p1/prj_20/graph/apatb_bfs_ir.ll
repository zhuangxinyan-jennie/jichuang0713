...
entry:
  ...
  call void @apatb_bfs_hw([128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, i64 %starting_node, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, i64* %8)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* %2, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.5.6([2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.7.8([128 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [128 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a10i64([10 x i64]* align 512 %4, [10 x i64]* %3)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.13.14([256 x %struct.node_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.15.16([4096 x %struct.edge_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.17.18([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #2 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a256i8.17.18([256 x i8]* %2, [128 x i8]* align 512 %_03, [128 x i8]* align 512 %_14)
  call fastcc void @onebyonecpy_hls.p0a10i64([10 x i64]* %3, [10 x i64]* align 512 %4)
  ret void
}

declare void @apatb_bfs_hw([128 x i128]*, [128 x i128]*, [2048 x i64]*, [2048 x i64]*, i64, [128 x i8]*, [128 x i8]*, i64*)
...
define void @bfs_hw_stub_wrapper([128 x i128]*, [128 x i128]*, [2048 x i64]*, [2048 x i64]*, i64, [128 x i8]*, [128 x i8]*, i64*) #6 {
entry:
  ...
  %10 = alloca [256 x i8]
  %11 = bitcast i64* %7 to [10 x i64]*
  call void @copy_out([256 x %struct.node_t_struct]* %8, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %9, [2048 x i64]* %2, [2048 x i64]* %3, [256 x i8]* %10, [128 x i8]* %5, [128 x i8]* %6, [10 x i64]* null, [10 x i64]* %11)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %8, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %9, [2048 x i64]* %2, [2048 x i64]* %3, [256 x i8]* %10, [128 x i8]* %5, [128 x i8]* %6, [10 x i64]* null, [10 x i64]* %11)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_20.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
