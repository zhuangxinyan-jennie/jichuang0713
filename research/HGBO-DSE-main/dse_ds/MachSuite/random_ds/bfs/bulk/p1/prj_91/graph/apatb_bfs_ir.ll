...
entry:
  ...
  %level_counts_copy_08 = alloca [3 x i128], align 512
  %level_counts_copy_19 = alloca [3 x i128], align 512
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, [256 x i8]* nonnull %2, [256 x i8]* nonnull align 512 %level_copy, [10 x i64]* nonnull %3, [3 x i128]* nonnull align 512 %level_counts_copy_08, [3 x i128]* nonnull align 512 %level_counts_copy_19)
  ...
  %level_counts_copy.gep_010 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_08, i64 0, i32 0
  %level_counts_copy.gep_111 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_19, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %level_counts_copy.gep_010, i32 0, i32 1, i32 0, i1 false) ], !dbg !41
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %level_counts_copy.gep_111, i32 0, i32 1, i32 0, i1 false) ], !dbg !41
  call void @apatb_bfs_hw([64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, i64 %starting_node, i8* %8, [3 x i128]* %level_counts_copy_08, [3 x i128]* %level_counts_copy_19)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [3 x i128]* %level_counts_copy_08, [3 x i128]* %level_counts_copy_19)
...
declare void @apatb_bfs_hw([64 x i256]*, [64 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, i8*, [3 x i128]*, [3 x i128]*)
...
define void @bfs_hw_stub_wrapper([64 x i256]*, [64 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, i8*, [3 x i128]*, [3 x i128]*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %8, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %9, [1024 x i128]* %2, [1024 x i128]* %3, [256 x i8]* null, [256 x i8]* %11, [10 x i64]* %10, [3 x i128]* %6, [3 x i128]* %7)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %8, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %9, [1024 x i128]* %2, [1024 x i128]* %3, [256 x i8]* null, [256 x i8]* %11, [10 x i64]* %10, [3 x i128]* %6, [3 x i128]* %7)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_91.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
