...
entry:
  ...
  %level_copy_05 = alloca [64 x i16], align 512
  %level_copy_16 = alloca [64 x i16], align 512
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i128]* %edges_copy4, [256 x i8]* nonnull %2, [64 x i16]* nonnull align 512 %level_copy_05, [64 x i16]* nonnull align 512 %level_copy_16, [10 x i64]* nonnull %3, [5 x i64]* nonnull align 512 %level_counts_copy_0, [5 x i64]* nonnull align 512 %level_counts_copy_1)
  ...
  %level_copy.gep_07 = getelementptr [64 x i16], [64 x i16]* %level_copy_05, i64 0, i32 0
  %level_copy.gep_18 = getelementptr [64 x i16], [64 x i16]* %level_copy_16, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %level_copy.gep_07, i32 0, i32 1, i32 0, i1 false) ], !dbg !41
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i16* %level_copy.gep_18, i32 0, i32 1, i32 0, i1 false) ], !dbg !41
  ...
  call void @apatb_bfs_hw([64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, [2048 x i128]* %edges_copy4, i64 %starting_node, [64 x i16]* %level_copy_05, [64 x i16]* %level_copy_16, [5 x i64]* %level_counts_copy_0, [5 x i64]* %level_counts_copy_1)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, [4096 x %struct.edge_t_struct]* %1, [2048 x i128]* %edges_copy4, [256 x i8]* %2, [64 x i16]* %level_copy_05, [64 x i16]* %level_copy_16, [10 x i64]* %3, [5 x i64]* %level_counts_copy_0, [5 x i64]* %level_counts_copy_1)
...
define internal void @onebyonecpy_hls.p0a10i64.7.8([5 x i64]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [5 x i64]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [10 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.17.18([10 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [5 x i64]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [5 x i64]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [64 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [2048 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias readonly "orig.arg.no"="4", [64 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_01, [64 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_12, [10 x i64]* noalias readonly "orig.arg.no"="6", [5 x i64]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [5 x i64]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #4 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.23([4096 x %struct.edge_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [2048 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_01, [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_12, [10 x i64]* noalias "orig.arg.no"="6", [5 x i64]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [5 x i64]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #5 {
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.13.14([256 x %struct.node_t_struct]* %0, [64 x i256]* %_0, [64 x i256]* %_1)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.23([4096 x %struct.edge_t_struct]* %1, [2048 x i128]* %2)
...
declare void @apatb_bfs_hw([64 x i256]*, [64 x i256]*, [2048 x i128]*, i64, [64 x i16]*, [64 x i16]*, [5 x i64]*, [5 x i64]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_01, [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_12, [10 x i64]* noalias "orig.arg.no"="6", [5 x i64]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [5 x i64]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #5 {
entry:
  call void @onebyonecpy_hls.p0a256i8.15.16([256 x i8]* %3, [64 x i16]* align 512 %_01, [64 x i16]* align 512 %_12)
  call void @onebyonecpy_hls.p0a10i64.17.18([10 x i64]* %4, [5 x i64]* align 512 %_03, [5 x i64]* align 512 %_14)
  ret void
...
define void @bfs_hw_stub_wrapper([64 x i256]*, [64 x i256]*, [2048 x i128]*, i64, [64 x i16]*, [64 x i16]*, [5 x i64]*, [5 x i64]*) #6 {
entry:
  ...
  %10 = alloca [256 x i8]
  %11 = alloca [10 x i64]
  call void @copy_out([256 x %struct.node_t_struct]* %8, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %9, [2048 x i128]* %2, [256 x i8]* %10, [64 x i16]* %4, [64 x i16]* %5, [10 x i64]* %11, [5 x i64]* %6, [5 x i64]* %7)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %8, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %9, [2048 x i128]* %2, [256 x i8]* %10, [64 x i16]* %4, [64 x i16]* %5, [10 x i64]* %11, [5 x i64]* %6, [5 x i64]* %7)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_61.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
