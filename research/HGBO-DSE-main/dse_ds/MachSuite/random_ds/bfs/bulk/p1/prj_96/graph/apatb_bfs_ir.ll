...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* nonnull %1, [4096 x i64]* %edges_copy, [256 x i8]* nonnull %2, [64 x i16]* nonnull align 512 %level_copy_03, [64 x i16]* nonnull align 512 %level_copy_14, [10 x i64]* nonnull %3, [3 x i128]* nonnull align 512 %level_counts_copy_05, [3 x i128]* nonnull align 512 %level_counts_copy_16)
  ...
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i16* %level_copy.gep_07, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i16* %level_copy.gep_18, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %level_counts_copy.gep_09, i32 0, i32 1, i32 0, i1 false) ], !dbg !41
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %level_counts_copy.gep_110, i32 0, i32 1, i32 0, i1 false) ], !dbg !41
  call void @apatb_bfs_hw([128 x i256]* %nodes_copy2, i64* %5, i64 %starting_node, [64 x i16]* %level_copy_03, [64 x i16]* %level_copy_14, [3 x i128]* %level_counts_copy_05, [3 x i128]* %level_counts_copy_16)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* %1, [4096 x i64]* %edges_copy, [256 x i8]* %2, [64 x i16]* %level_copy_03, [64 x i16]* %level_copy_14, [10 x i64]* %3, [3 x i128]* %level_counts_copy_05, [3 x i128]* %level_counts_copy_16)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.27([128 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x %struct.node_t_struct]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.27([128 x i256]* %1, [256 x %struct.node_t_struct]* %0)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.11.12([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #2 {
entry:
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a4096struct.edge_t_struct.19([4096 x %struct.edge_t_struct]* %2, [4096 x i64]* %3)
...
declare void @apatb_bfs_hw([128 x i256]*, i64*, i64, [64 x i16]*, [64 x i16]*, [3 x i128]*, [3 x i128]*)
...
define void @bfs_hw_stub_wrapper([128 x i256]*, i64*, i64, [64 x i16]*, [64 x i16]*, [3 x i128]*, [3 x i128]*) #6 {
entry:
  ...
  %9 = alloca [256 x i8]
  %10 = alloca [10 x i64]
  %11 = bitcast i64* %1 to [4096 x i64]*
  call void @copy_out([256 x %struct.node_t_struct]* %7, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %8, [4096 x i64]* %11, [256 x i8]* %9, [64 x i16]* %3, [64 x i16]* %4, [10 x i64]* %10, [3 x i128]* %5, [3 x i128]* %6)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %8, [4096 x i64]* %11, [256 x i8]* %9, [64 x i16]* %3, [64 x i16]* %4, [10 x i64]* %10, [3 x i128]* %5, [3 x i128]* %6)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_96.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
