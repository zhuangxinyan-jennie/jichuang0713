...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy4, [10 x i64]* nonnull %3, [5 x i64]* nonnull align 512 %level_counts_copy_0, [5 x i64]* nonnull align 512 %level_counts_copy_1)
  ...
  %level_copy.gep5 = getelementptr [128 x i16], [128 x i16]* %level_copy4, i64 0, i32 0
  ...
  call void @apatb_bfs_hw(i128* %4, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, i64 %starting_node, [128 x i16]* %level_copy4, [5 x i64]* %level_counts_copy_0, [5 x i64]* %level_counts_copy_1)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, [256 x i8]* %2, [128 x i16]* %level_copy4, [10 x i64]* %3, [5 x i64]* %level_counts_copy_0, [5 x i64]* %level_counts_copy_1)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.44.45([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a256i8.44.45([256 x i8]* %3, [128 x i16]* align 512 %4)
  call void @onebyonecpy_hls.p0a10i64.13.14([10 x i64]* %5, [5 x i64]* align 512 %_01, [5 x i64]* align 512 %_12)
  ret void
}

declare void @apatb_bfs_hw(i128*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i16]*, [5 x i64]*, [5 x i64]*)
...
define void @bfs_hw_stub_wrapper(i128*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i16]*, [5 x i64]*, [5 x i64]*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %7, [256 x i128]* %11, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* %9, [128 x i16]* %4, [10 x i64]* %10, [5 x i64]* %5, [5 x i64]* %6)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [256 x i128]* %11, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* %9, [128 x i16]* %4, [10 x i64]* %10, [5 x i64]* %5, [5 x i64]* %6)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_97.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
