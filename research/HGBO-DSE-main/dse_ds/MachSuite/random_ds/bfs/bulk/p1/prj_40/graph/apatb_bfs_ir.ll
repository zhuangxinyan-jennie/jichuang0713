...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, [256 x i8]* nonnull %2, [256 x i8]* nonnull align 512 %level_copy, [10 x i64]* nonnull %3, [5 x i128]* nonnull align 512 %level_counts_copy4)
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep5, i32 0, i32 1, i32 0) ], !dbg !40
  call void @apatb_bfs_hw(i128* %4, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, i64 %starting_node, i8* %7, [5 x i128]* %level_counts_copy4)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [5 x i128]* %level_counts_copy4)
...
declare void @apatb_bfs_hw(i128*, [1024 x i128]*, [1024 x i128]*, i64, i8*, [5 x i128]*)
...
define void @bfs_hw_stub_wrapper(i128*, [1024 x i128]*, [1024 x i128]*, i64, i8*, [5 x i128]*) #6 {
entry:
  ...
  %10 = bitcast i8* %4 to [256 x i8]*
  call void @copy_out([256 x %struct.node_t_struct]* %6, [256 x i128]* %9, [4096 x %struct.edge_t_struct]* %7, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* null, [256 x i8]* %10, [10 x i64]* %8, [5 x i128]* %5)
  ...
  %14 = bitcast [10 x i64]* %8 to i64*
  call void @bfs_hw_stub(%struct.node_t_struct* %11, %struct.edge_t_struct* %12, i64 %3, i8* %13, i64* %14)
  call void @copy_in([256 x %struct.node_t_struct]* %6, [256 x i128]* %9, [4096 x %struct.edge_t_struct]* %7, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* null, [256 x i8]* %10, [10 x i64]* %8, [5 x i128]* %5)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_40.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
