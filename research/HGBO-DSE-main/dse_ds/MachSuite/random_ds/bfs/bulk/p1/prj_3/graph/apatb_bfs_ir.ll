...
entry:
  ...
  %level_copy3 = alloca [128 x i16], align 512
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i128]* %edges_copy2, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy3, [10 x i64]* nonnull %3, [5 x i128]* nonnull align 512 %level_counts_copy4)
  ...
  %level_copy.gep5 = getelementptr [128 x i16], [128 x i16]* %level_copy3, i64 0, i32 0
  %level_counts_copy.gep6 = getelementptr [5 x i128], [5 x i128]* %level_counts_copy4, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep5, i32 0, i32 1, i32 0) ], !dbg !41
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep6, i32 0, i32 1, i32 0) ], !dbg !42
  call void @apatb_bfs_hw([128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [2048 x i128]* %edges_copy2, i64 %starting_node, [128 x i16]* %level_copy3, [5 x i128]* %level_counts_copy4)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* %1, [2048 x i128]* %edges_copy2, [256 x i8]* %2, [128 x i16]* %level_copy3, [10 x i64]* %3, [5 x i128]* %level_counts_copy4)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.9.10([256 x %struct.node_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.32.33([128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.34.35([5 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [10 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [128 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [2048 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias readonly "orig.arg.no"="4", [128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias readonly "orig.arg.no"="6", [5 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7") #4 {
entry:
  ...
  call void @onebyonecpy_hls.p0a256i8.32.33([128 x i16]* align 512 %4, [256 x i8]* %3)
  call void @onebyonecpy_hls.p0a10i64.34.35([5 x i128]* align 512 %6, [10 x i64]* %5)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.25([4096 x %struct.edge_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [2048 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.42.43([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7") #5 {
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.9.10([256 x %struct.node_t_struct]* %0, [128 x i128]* %_0, [128 x i128]* %_1)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.25([4096 x %struct.edge_t_struct]* %1, [2048 x i128]* %2)
  call void @onebyonecpy_hls.p0a256i8.42.43([256 x i8]* %3, [128 x i16]* align 512 %4)
  call void @onebyonecpy_hls.p0a10i64.44.45([10 x i64]* %5, [5 x i128]* align 512 %6)
  ret void
}

declare void @apatb_bfs_hw([128 x i128]*, [128 x i128]*, [2048 x i128]*, i64, [128 x i16]*, [5 x i128]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7") #5 {
entry:
  call void @onebyonecpy_hls.p0a256i8.42.43([256 x i8]* %3, [128 x i16]* align 512 %4)
  call void @onebyonecpy_hls.p0a10i64.44.45([10 x i64]* %5, [5 x i128]* align 512 %6)
  ret void
...
define void @bfs_hw_stub_wrapper([128 x i128]*, [128 x i128]*, [2048 x i128]*, i64, [128 x i16]*, [5 x i128]*) #6 {
entry:
  ...
  %8 = alloca [256 x i8]
  %9 = alloca [10 x i64]
  call void @copy_out([256 x %struct.node_t_struct]* %6, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %7, [2048 x i128]* %2, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* %9, [5 x i128]* %5)
  ...
  call void @bfs_hw_stub(%struct.node_t_struct* %10, %struct.edge_t_struct* %11, i64 %3, i8* %12, i64* %13)
  call void @copy_in([256 x %struct.node_t_struct]* %6, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %7, [2048 x i128]* %2, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* %9, [5 x i128]* %5)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_3.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
