...
entry:
  ...
  %level_copy4 = alloca [128 x i16], align 512
  %level_counts_copy_05 = alloca [3 x i128], align 512
  %level_counts_copy_16 = alloca [3 x i128], align 512
  ...
  %level_copy.gep7 = getelementptr [128 x i16], [128 x i16]* %level_copy4, i64 0, i32 0
  %level_counts_copy.gep_08 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_05, i64 0, i32 0
  %level_counts_copy.gep_19 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_16, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep7, i32 0, i32 1, i32 0) ], !dbg !41
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i128* %level_counts_copy.gep_08, i32 0, i32 1, i32 0, i1 false) ], !dbg !42
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i128* %level_counts_copy.gep_19, i32 0, i32 1, i32 0, i1 false) ], !dbg !42
  call void @apatb_bfs_hw([128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, i64 %starting_node, [128 x i16]* %level_copy4, [3 x i128]* %level_counts_copy_05, [3 x i128]* %level_counts_copy_16)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* %2, [128 x i16]* %level_copy4, [10 x i64]* %3, [3 x i128]* %level_counts_copy_05, [3 x i128]* %level_counts_copy_16)
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep_08, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep_19, i32 0, i32 1, i32 0) ]
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.15.16([4096 x %struct.edge_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.41.42([128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.7.8([3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [10 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [128 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias readonly "orig.arg.no"="4", [128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias readonly "orig.arg.no"="6", [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #4 {
entry:
  ...
  call void @onebyonecpy_hls.p0a256i8.41.42([128 x i16]* align 512 %3, [256 x i8]* %2)
  call void @onebyonecpy_hls.p0a10i64.7.8([3 x i128]* align 512 %_03, [3 x i128]* align 512 %_14, [10 x i64]* %4)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.49.50([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.17.18([10 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias "orig.arg.no"="4", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #5 {
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.13.14([256 x %struct.node_t_struct]* %0, [128 x i128]* %_0, [128 x i128]* %_1)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.15.16([4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %_01, [2048 x i64]* %_12)
  call void @onebyonecpy_hls.p0a256i8.49.50([256 x i8]* %2, [128 x i16]* align 512 %3)
  call void @onebyonecpy_hls.p0a10i64.17.18([10 x i64]* %4, [3 x i128]* align 512 %_03, [3 x i128]* align 512 %_14)
  ret void
}

declare void @apatb_bfs_hw([128 x i128]*, [128 x i128]*, [2048 x i64]*, [2048 x i64]*, i64, [128 x i16]*, [3 x i128]*, [3 x i128]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias "orig.arg.no"="4", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #5 {
entry:
  call void @onebyonecpy_hls.p0a256i8.49.50([256 x i8]* %2, [128 x i16]* align 512 %3)
  call void @onebyonecpy_hls.p0a10i64.17.18([10 x i64]* %4, [3 x i128]* align 512 %_03, [3 x i128]* align 512 %_14)
  ret void
...
define void @bfs_hw_stub_wrapper([128 x i128]*, [128 x i128]*, [2048 x i64]*, [2048 x i64]*, i64, [128 x i16]*, [3 x i128]*, [3 x i128]*) #6 {
entry:
  ...
  %10 = alloca [256 x i8]
  %11 = alloca [10 x i64]
  call void @copy_out([256 x %struct.node_t_struct]* %8, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %9, [2048 x i64]* %2, [2048 x i64]* %3, [256 x i8]* %10, [128 x i16]* %5, [10 x i64]* %11, [3 x i128]* %6, [3 x i128]* %7)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %8, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %9, [2048 x i64]* %2, [2048 x i64]* %3, [256 x i8]* %10, [128 x i16]* %5, [10 x i64]* %11, [3 x i128]* %6, [3 x i128]* %7)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_9.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
