...
entry:
  ...
  call void @apatb_bfs_hw(i128* %4, [2048 x i128]* %edges_copy2, i64 %starting_node, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [5 x i128]* %level_counts_copy3)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [2048 x i128]* %edges_copy2, [256 x i8]* %2, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [10 x i64]* %3, [5 x i128]* %level_counts_copy3)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.9.10([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.23([2048 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [4096 x %struct.edge_t_struct]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.29.30([5 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [10 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.23([2048 x i128]* %3, [4096 x %struct.edge_t_struct]* %2)
  call void @onebyonecpy_hls.p0a256i8.3.4([128 x i8]* align 512 %_0, [128 x i8]* align 512 %_1, [256 x i8]* %4)
  call void @onebyonecpy_hls.p0a10i64.29.30([5 x i128]* align 512 %6, [10 x i64]* %5)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.37.38([10 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a10i64.37.38([10 x i64]* %5, [5 x i128]* align 512 %6)
  ret void
}

declare void @apatb_bfs_hw(i128*, [2048 x i128]*, i64, [128 x i8]*, [128 x i8]*, [5 x i128]*)
...
define void @bfs_hw_stub_wrapper(i128*, [2048 x i128]*, i64, [128 x i8]*, [128 x i8]*, [5 x i128]*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %6, [256 x i128]* %10, [4096 x %struct.edge_t_struct]* %7, [2048 x i128]* %1, [256 x i8]* %8, [128 x i8]* %3, [128 x i8]* %4, [10 x i64]* %9, [5 x i128]* %5)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [256 x i128]* %10, [4096 x %struct.edge_t_struct]* %7, [2048 x i128]* %1, [256 x i8]* %8, [128 x i8]* %3, [128 x i8]* %4, [10 x i64]* %9, [5 x i128]* %5)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_73.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
