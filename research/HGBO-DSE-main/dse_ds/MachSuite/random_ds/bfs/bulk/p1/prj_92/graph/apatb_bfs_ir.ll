...
entry:
  ...
  %edges_copy_02 = bitcast i8* %malloccall1_0 to [1024 x i128]*
  %malloccall1_1 = call i8* @malloc(i64 16384)
  %edges_copy_13 = bitcast i8* %malloccall1_1 to [1024 x i128]*
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, [256 x i8]* nonnull %2, [256 x i8]* nonnull align 512 %level_copy, [10 x i64]* nonnull %3, [3 x i128]* nonnull align 512 %level_counts_copy_04, [3 x i128]* nonnull align 512 %level_counts_copy_15)
  %4 = getelementptr [256 x i128], [256 x i128]* %nodes_copy, i32 0, i32 0
  %5 = getelementptr [1024 x i128], [1024 x i128]* %edges_copy_02, i32 0, i32 0
  %6 = getelementptr [1024 x i128], [1024 x i128]* %edges_copy_13, i32 0, i32 0
  ...
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i128* %5, i32 0, i32 1, i32 0, i1 false) ], !dbg !5
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i128* %6, i32 0, i32 1, i32 0, i1 false) ], !dbg !5
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i128* %level_counts_copy.gep_06, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i128* %level_counts_copy.gep_17, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @apatb_bfs_hw(i128* %4, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, i64 %starting_node, i8* %7, [3 x i128]* %level_counts_copy_04, [3 x i128]* %level_counts_copy_15)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [3 x i128]* %level_counts_copy_04, [3 x i128]* %level_counts_copy_15)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [256 x i128]* noalias "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [1024 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [1024 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [256 x i8]* noalias readonly "orig.arg.no"="4", [256 x i8]* noalias align 512 "orig.arg.no"="5", [10 x i64]* noalias readonly "orig.arg.no"="6", [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_01, [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_12) #4 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [256 x i128]* noalias readonly "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [256 x i8]* noalias "orig.arg.no"="4", [256 x i8]* noalias readonly align 512 "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_01, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_12) #5 {
entry:
...
declare void @apatb_bfs_hw(i128*, [1024 x i128]*, [1024 x i128]*, i64, i8*, [3 x i128]*, [3 x i128]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [256 x i128]* noalias readonly "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [256 x i8]* noalias "orig.arg.no"="4", [256 x i8]* noalias readonly align 512 "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_01, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_12) #5 {
entry:
  call fastcc void @onebyonecpy_hls.p0a256i8([256 x i8]* %3, [256 x i8]* align 512 %4)
  call void @onebyonecpy_hls.p0a10i64.13.14([10 x i64]* %5, [3 x i128]* align 512 %_01, [3 x i128]* align 512 %_12)
  ret void
...
define void @bfs_hw_stub_wrapper(i128*, [1024 x i128]*, [1024 x i128]*, i64, i8*, [3 x i128]*, [3 x i128]*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %7, [256 x i128]* %10, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* null, [256 x i8]* %11, [10 x i64]* %9, [3 x i128]* %5, [3 x i128]* %6)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [256 x i128]* %10, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* null, [256 x i8]* %11, [10 x i64]* %9, [3 x i128]* %5, [3 x i128]* %6)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_92.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
