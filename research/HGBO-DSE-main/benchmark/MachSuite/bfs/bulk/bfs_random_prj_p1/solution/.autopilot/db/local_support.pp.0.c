...
# 1 "<command line>" 1
# 1 "<built-in>" 2
# 1 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot/etc/autopilot_ssdm_op.h" 1
# 316 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/common/technology/autopilot/etc/autopilot_ssdm_op.h"
...
# 1 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 1 3 4
# 62 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 3 4
typedef long unsigned int size_t;
# 90 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stddef.h" 3 4
typedef int wchar_t;
...
# 8 "./bfs.h" 2
# 1 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/inttypes.h" 1 3
# 30 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/inttypes.h" 3
# 1 "/usr/include/inttypes.h" 1 3 4
# 27 "/usr/include/inttypes.h" 3 4
# 1 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 1 3 4
# 63 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 3 4
...
# 64 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdint.h" 2 3 4
...
extern uintmax_t wcstoumax (const __gwchar_t *__restrict __nptr,
       __gwchar_t ** __restrict __endptr, int __base)
     __attribute__ ((__nothrow__ ));
# 31 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/inttypes.h" 2 3
# 9 "./bfs.h" 2
...
# 1 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 1 3 4
# 30 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 3 4
typedef __builtin_va_list va_list;
# 48 "/home/noel/Programs/Xilinx/Vitis_HLS/2022.1/lnx64/tools/clang-3.9-csynth/lib/clang/7.0.0/include/stdarg.h" 3 4
...
struct bench_args_t {
  node_t nodes[(1LL<<8)];
  edge_t edges[((1LL<<8)*16)];
  node_index_t starting_node;
  level_t level[(1LL<<8)];
  edge_index_t level_counts[10];
};

void bfs(node_t nodes[(1LL<<8)], edge_t edges[((1LL<<8)*16)], node_index_t starting_node, level_t level[(1LL<<8)], edge_index_t level_counts[10]);
# 2 "local_support.c" 2
...
void input_to_data(int fd, void *vdata) {
  ...
  VITIS_LOOP_30_1: for(i=0; i<(1LL<<8); i++) {
    data->level[i]=(127);
  }
  ...
  nodes = (uint64_t *)malloc((1LL<<8)*2*sizeof(uint64_t));
  parse_uint64_t_array(s, nodes, (1LL<<8)*2);
  VITIS_LOOP_43_2: for(i=0; i<(1LL<<8); i++) {
  ...
  parse_uint64_t_array(s, (uint64_t *)(data->edges), ((1LL<<8)*16));
  free(p);
}
...
void data_to_input(int fd, void *vdata) {
  ...
  write_section_header(fd);
  nodes = (uint64_t *)malloc((1LL<<8)*2*sizeof(uint64_t));
  VITIS_LOOP_65_1: for(i=0; i<(1LL<<8); i++) {
    nodes[2*i] = data->nodes[i].edge_begin;
    nodes[2*i+1]= data->nodes[i].edge_end;
  }
  write_uint64_t_array(fd, nodes, (1LL<<8)*2);
  free(nodes);

  write_section_header(fd);
  write_uint64_t_array(fd, (uint64_t *)(&data->edges), ((1LL<<8)*16));
}
...
void output_to_data(int fd, void *vdata) {
  ...
  s = find_section_start(p,1);
  parse_uint64_t_array(s, data->level_counts, 10);
  free(p);
}
...
void data_to_output(int fd, void *vdata) {
  ...
  write_section_header(fd);
  write_uint64_t_array(fd, data->level_counts, 10);
}
...
int check_data( void *vdata, void *vref ) {
  ...
  VITIS_LOOP_108_1: for(i=0; i<10; i++) {
