...
def classify_lateral(
    *,
    ...
    try:
        ...
        fw = 0.0
    empty = {"zone": "unknown", "offset": None, "source": None, "cx": None}
    if fw <= 1:
        return empty
    ...
    if abs(offset) <= CENTER_MAX:
        ...
        zone = "center"
    return {"zone": zone, "offset": round(offset, 4), "source": source, "cx": round(cx, 2)}
