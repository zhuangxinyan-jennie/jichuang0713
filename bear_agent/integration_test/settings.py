...
class ServerSettings:
    ...
    # 播完后继续挡一阵，排空板端对喇叭回声的 final；默认 1s（可用 BEAR_AGENT_PLAYBACK_DRAIN_SEC 调）
    playback_drain_sec: float = 1.0
...
def load_server_settings() -> ServerSettings:
    ...
    return ServerSettings(
        ...
        playback_drain_sec=env_float("BEAR_AGENT_PLAYBACK_DRAIN_SEC", 1.0),
    )
