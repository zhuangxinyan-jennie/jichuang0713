# -*- coding: utf-8 -*-
"""Write demo launchers as UTF-8 with BOM for Windows PowerShell 5.1."""
...
try {
    ...
    if ($BoardSpeaker) {
        ...
        Write-Host " Speak to BOARD camera + mic; audio on PC speakers" -ForegroundColor Magenta
    }
...
(ROOT / "start-full-demo.ps1").write_text(START.lstrip("\n"), encoding="utf-8-sig")
(ROOT / "stop-full-demo.ps1").write_text(STOP.lstrip("\n"), encoding="utf-8-sig")
print("wrote start-full-demo.ps1 / stop-full-demo.ps1 with UTF-8 BOM")
