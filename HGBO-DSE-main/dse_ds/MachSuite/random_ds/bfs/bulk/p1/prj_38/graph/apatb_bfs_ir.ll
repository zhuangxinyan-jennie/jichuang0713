...
entry:
  ...
  call void @apatb_bfs_hw([64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, i64 %starting_node, i8* %8, i64* %9)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
declare void @apatb_bfs_hw([64 x i256]*, [64 x i256]*, [2048 x i64]*, [2048 x i64]*, i64, i8*, i64*)
...
define void @bfs_hw_stub_wrapper([64 x i256]*, [64 x i256]*, [2048 x i64]*, [2048 x i64]*, i64, i8*, i64*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %7, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %8, [2048 x i64]* %2, [2048 x i64]* %3, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* null, [10 x i64]* %10)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %8, [2048 x i64]* %2, [2048 x i64]* %3, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* null, [10 x i64]* %10)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_38.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
