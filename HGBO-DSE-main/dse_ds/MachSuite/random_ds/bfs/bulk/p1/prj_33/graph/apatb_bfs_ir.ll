...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy2, [10 x i64]* nonnull %3, [5 x i128]* nonnull align 512 %level_counts_copy3)
  ...
  %level_copy.gep4 = getelementptr [128 x i16], [128 x i16]* %level_copy2, i64 0, i32 0
  %level_counts_copy.gep5 = getelementptr [5 x i128], [5 x i128]* %level_counts_copy3, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep4, i32 0, i32 1, i32 0) ], !dbg !40
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep5, i32 0, i32 1, i32 0) ], !dbg !41
  call void @apatb_bfs_hw(i128* %4, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, i64 %starting_node, [128 x i16]* %level_copy2, [5 x i128]* %level_counts_copy3)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* %2, [128 x i16]* %level_copy2, [10 x i64]* %3, [5 x i128]* %level_counts_copy3)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0a256struct.node_t_struct.25([256 x %struct.node_t_struct]* noalias, [256 x i128]* noalias readonly) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.38.39([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  call fastcc void @onebyonecpy_hls.p0a256struct.node_t_struct.25([256 x %struct.node_t_struct]* %0, [256 x i128]* %1)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.9.10([4096 x %struct.edge_t_struct]* %2, [2048 x i64]* %_0, [2048 x i64]* %_1)
  call void @onebyonecpy_hls.p0a256i8.38.39([256 x i8]* %3, [128 x i16]* align 512 %4)
  call void @onebyonecpy_hls.p0a10i64.40.41([10 x i64]* %5, [5 x i128]* align 512 %6)
  ret void
}

declare void @apatb_bfs_hw(i128*, [2048 x i64]*, [2048 x i64]*, i64, [128 x i16]*, [5 x i128]*)
...
define void @bfs_hw_stub_wrapper(i128*, [2048 x i64]*, [2048 x i64]*, i64, [128 x i16]*, [5 x i128]*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %6, [256 x i128]* %10, [4096 x %struct.edge_t_struct]* %7, [2048 x i64]* %1, [2048 x i64]* %2, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* %9, [5 x i128]* %5)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [256 x i128]* %10, [4096 x %struct.edge_t_struct]* %7, [2048 x i64]* %1, [2048 x i64]* %2, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* %9, [5 x i128]* %5)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_33.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
