...
entry:
  ...
  call void @apatb_bfs_hw([64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, i64* %6, i64 %starting_node, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, i64* %7)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, [4096 x %struct.edge_t_struct]* %1, [4096 x i64]* %edges_copy, [256 x i8]* %2, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
declare void @apatb_bfs_hw([64 x i256]*, [64 x i256]*, i64*, i64, [128 x i8]*, [128 x i8]*, i64*)
...
define void @bfs_hw_stub_wrapper([64 x i256]*, [64 x i256]*, i64*, i64, [128 x i8]*, [128 x i8]*, i64*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %7, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %8, [4096 x i64]* %10, [256 x i8]* %9, [128 x i8]* %4, [128 x i8]* %5, [10 x i64]* null, [10 x i64]* %11)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %8, [4096 x i64]* %10, [256 x i8]* %9, [128 x i8]* %4, [128 x i8]* %5, [10 x i64]* null, [10 x i64]* %11)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_15.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
