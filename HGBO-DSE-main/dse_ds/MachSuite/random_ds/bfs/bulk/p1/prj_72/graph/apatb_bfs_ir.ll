...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i128]* %edges_copy4, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy5, [10 x i64]* nonnull %3, [3 x i128]* nonnull align 512 %level_counts_copy_06, [3 x i128]* nonnull align 512 %level_counts_copy_17)
  ...
  %level_copy.gep8 = getelementptr [128 x i16], [128 x i16]* %level_copy5, i64 0, i32 0
  %level_counts_copy.gep_09 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_06, i64 0, i32 0
  %level_counts_copy.gep_110 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_17, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep8, i32 0, i32 1, i32 0) ], !dbg !41
  ...
  call void @apatb_bfs_hw([64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, [2048 x i128]* %edges_copy4, i64 %starting_node, [128 x i16]* %level_copy5, [3 x i128]* %level_counts_copy_06, [3 x i128]* %level_counts_copy_17)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [64 x i256]* %nodes_copy_02, [64 x i256]* %nodes_copy_13, [4096 x %struct.edge_t_struct]* %1, [2048 x i128]* %edges_copy4, [256 x i8]* %2, [128 x i16]* %level_copy5, [10 x i64]* %3, [3 x i128]* %level_counts_copy_06, [3 x i128]* %level_counts_copy_17)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.50.51([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a256i8.50.51([256 x i8]* %3, [128 x i16]* align 512 %4)
  call void @onebyonecpy_hls.p0a10i64.13.14([10 x i64]* %5, [3 x i128]* align 512 %_01, [3 x i128]* align 512 %_12)
  ret void
}

declare void @apatb_bfs_hw([64 x i256]*, [64 x i256]*, [2048 x i128]*, i64, [128 x i16]*, [3 x i128]*, [3 x i128]*)
...
define void @bfs_hw_stub_wrapper([64 x i256]*, [64 x i256]*, [2048 x i128]*, i64, [128 x i16]*, [3 x i128]*, [3 x i128]*) #6 {
entry:
  ...
  %9 = alloca [256 x i8]
  %10 = alloca [10 x i64]
  call void @copy_out([256 x %struct.node_t_struct]* %7, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %8, [2048 x i128]* %2, [256 x i8]* %9, [128 x i16]* %4, [10 x i64]* %10, [3 x i128]* %5, [3 x i128]* %6)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %8, [2048 x i128]* %2, [256 x i8]* %9, [128 x i16]* %4, [10 x i64]* %10, [3 x i128]* %5, [3 x i128]* %6)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_72.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
