...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* nonnull %1, [4096 x i64]* %edges_copy, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy2, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  call void @apatb_bfs_hw([128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, i64* %6, i64 %starting_node, [128 x i16]* %level_copy2, i64* %7)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* %1, [4096 x i64]* %edges_copy, [256 x i8]* %2, [128 x i16]* %level_copy2, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.30.31([128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a256i8.30.31([128 x i16]* align 512 %4, [256 x i8]* %3)
  call fastcc void @onebyonecpy_hls.p0a10i64([10 x i64]* align 512 %6, [10 x i64]* %5)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.36.37([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a4096struct.edge_t_struct.15([4096 x %struct.edge_t_struct]* %1, [4096 x i64]* %2)
  call void @onebyonecpy_hls.p0a256i8.36.37([256 x i8]* %3, [128 x i16]* align 512 %4)
  call fastcc void @onebyonecpy_hls.p0a10i64([10 x i64]* %5, [10 x i64]* align 512 %6)
  ret void
}

declare void @apatb_bfs_hw([128 x i128]*, [128 x i128]*, i64*, i64, [128 x i16]*, i64*)
...
define void @bfs_hw_stub_wrapper([128 x i128]*, [128 x i128]*, i64*, i64, [128 x i16]*, i64*) #6 {
entry:
  ...
  %8 = alloca [256 x i8]
  %9 = bitcast i64* %2 to [4096 x i64]*
  %10 = bitcast i64* %5 to [10 x i64]*
  call void @copy_out([256 x %struct.node_t_struct]* %6, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %7, [4096 x i64]* %9, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* null, [10 x i64]* %10)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %7, [4096 x i64]* %9, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* null, [10 x i64]* %10)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_64.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
