...
entry:
  ...
  %level_counts_copy_02 = alloca [3 x i128], align 512
  %level_counts_copy_13 = alloca [3 x i128], align 512
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* nonnull %1, [4096 x i64]* %edges_copy, [256 x i8]* nonnull %2, [256 x i8]* nonnull align 512 %level_copy, [10 x i64]* nonnull %3, [3 x i128]* nonnull align 512 %level_counts_copy_02, [3 x i128]* nonnull align 512 %level_counts_copy_13)
  ...
  %level_counts_copy.gep_04 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_02, i64 0, i32 0
  %level_counts_copy.gep_15 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_13, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i128* %level_counts_copy.gep_04, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i128* %level_counts_copy.gep_15, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @apatb_bfs_hw([128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, i64* %6, i64 %starting_node, i8* %7, [3 x i128]* %level_counts_copy_02, [3 x i128]* %level_counts_copy_13)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* %1, [4096 x i64]* %edges_copy, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [3 x i128]* %level_counts_copy_02, [3 x i128]* %level_counts_copy_13)
  call void @free(i8* %malloccall_0)
  call void @free(i8* %malloccall_1)
  call void @free(i8* %malloccall1)
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep_04, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep_15, i32 0, i32 1, i32 0) ]
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [128 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [4096 x i64]* noalias "orig.arg.no"="3", [256 x i8]* noalias readonly "orig.arg.no"="4", [256 x i8]* noalias align 512 "orig.arg.no"="5", [10 x i64]* noalias readonly "orig.arg.no"="6", [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_01, [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_12) #4 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [4096 x i64]* noalias readonly "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [256 x i8]* noalias readonly align 512 "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_01, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_12) #5 {
entry:
...
declare void @apatb_bfs_hw([128 x i128]*, [128 x i128]*, i64*, i64, i8*, [3 x i128]*, [3 x i128]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [4096 x i64]* noalias readonly "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [256 x i8]* noalias readonly align 512 "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_01, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_12) #5 {
entry:
  call fastcc void @onebyonecpy_hls.p0a256i8([256 x i8]* %3, [256 x i8]* align 512 %4)
  call void @onebyonecpy_hls.p0a10i64.13.14([10 x i64]* %5, [3 x i128]* align 512 %_01, [3 x i128]* align 512 %_12)
  ret void
...
define void @bfs_hw_stub_wrapper([128 x i128]*, [128 x i128]*, i64*, i64, i8*, [3 x i128]*, [3 x i128]*) #6 {
entry:
  ...
  %9 = alloca [10 x i64]
  %10 = bitcast i64* %2 to [4096 x i64]*
  %11 = bitcast i8* %4 to [256 x i8]*
  call void @copy_out([256 x %struct.node_t_struct]* %7, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %8, [4096 x i64]* %10, [256 x i8]* null, [256 x i8]* %11, [10 x i64]* %9, [3 x i128]* %5, [3 x i128]* %6)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %8, [4096 x i64]* %10, [256 x i8]* null, [256 x i8]* %11, [10 x i64]* %9, [3 x i128]* %5, [3 x i128]* %6)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_19.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
