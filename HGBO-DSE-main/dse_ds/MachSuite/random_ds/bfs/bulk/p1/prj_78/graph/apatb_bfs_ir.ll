...
entry:
  ...
  %nodes_copy_04 = bitcast i8* %malloccall_0 to [64 x i256]*
  %malloccall_1 = call i8* @malloc(i64 2048)
  %nodes_copy_15 = bitcast i8* %malloccall_1 to [64 x i256]*
  %malloccall1_0 = call i8* @malloc(i64 16384)
  %edges_copy_06 = bitcast i8* %malloccall1_0 to [1024 x i128]*
  %malloccall1_1 = call i8* @malloc(i64 16384)
  %edges_copy_17 = bitcast i8* %malloccall1_1 to [1024 x i128]*
  %level_copy_08 = alloca [64 x i16], align 512
  %level_copy_19 = alloca [64 x i16], align 512
  %level_counts_copy_010 = alloca [3 x i128], align 512
  %level_counts_copy_111 = alloca [3 x i128], align 512
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, [256 x i8]* nonnull %2, [64 x i16]* nonnull align 512 %level_copy_08, [64 x i16]* nonnull align 512 %level_copy_19, [10 x i64]* nonnull %3, [3 x i128]* nonnull align 512 %level_counts_copy_010, [3 x i128]* nonnull align 512 %level_counts_copy_111)
  %4 = getelementptr [64 x i256], [64 x i256]* %nodes_copy_04, i32 0, i32 0
  %5 = getelementptr [64 x i256], [64 x i256]* %nodes_copy_15, i32 0, i32 0
  %6 = getelementptr [1024 x i128], [1024 x i128]* %edges_copy_06, i32 0, i32 0
  %7 = getelementptr [1024 x i128], [1024 x i128]* %edges_copy_17, i32 0, i32 0
  %level_copy.gep_012 = getelementptr [64 x i16], [64 x i16]* %level_copy_08, i64 0, i32 0
  %level_copy.gep_113 = getelementptr [64 x i16], [64 x i16]* %level_copy_19, i64 0, i32 0
  %level_counts_copy.gep_014 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_010, i64 0, i32 0
  %level_counts_copy.gep_115 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_111, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %6, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %7, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #9 [ "xlx_array_partition"(i16* %level_copy.gep_012, i32 0, i32 1, i32 0, i1 false) ], !dbg !41
  call void @llvm.sideeffect() #9 [ "xlx_array_partition"(i16* %level_copy.gep_113, i32 0, i32 1, i32 0, i1 false) ], !dbg !41
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %level_counts_copy.gep_014, i32 0, i32 1, i32 0, i1 false) ], !dbg !42
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %level_counts_copy.gep_115, i32 0, i32 1, i32 0, i1 false) ], !dbg !42
  call void @apatb_bfs_hw([64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, i64 %starting_node, [64 x i16]* %level_copy_08, [64 x i16]* %level_copy_19, [3 x i128]* %level_counts_copy_010, [3 x i128]* %level_counts_copy_111)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, [256 x i8]* %2, [64 x i16]* %level_copy_08, [64 x i16]* %level_copy_19, [10 x i64]* %3, [3 x i128]* %level_counts_copy_010, [3 x i128]* %level_counts_copy_111)
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %6, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %7, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep_012, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep_113, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep_014, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep_115, i32 0, i32 1, i32 0) ]
  ret void
}
...
for.loop:                                         ; preds = %dst.addr.14.exit, %copy
  ...
  %4 = urem i64 %for.loop.idx5, 2
  %5 = udiv i64 %for.loop.idx5, 2
  %6 = udiv i64 %5, 64
  %7 = mul i64 128, %6
  %8 = urem i64 %5, 64
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.5.6([1024 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [1024 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
for.loop:                                         ; preds = %dst.addr.02.exit, %copy
  ...
  %4 = udiv i64 %for.loop.idx3, 2048
  %5 = urem i64 %for.loop.idx3, 2048
  %6 = urem i64 %5, 2
  %7 = mul i64 64, %6
  %8 = udiv i64 %5, 2
  %9 = getelementptr [1024 x i128], [1024 x i128]* %_0, i64 0, i64 %8
  %10 = getelementptr [1024 x i128], [1024 x i128]* %_1, i64 0, i64 %8
  %11 = load i64, i64* %src.addr.01, align 8
  %12 = trunc i64 %4 to i1
  %cond = icmp eq i1 %12, false
  %13 = zext i64 %7 to i128
  %14 = shl i128 18446744073709551615, %13
...
dst.addr.02.case.0:                               ; preds = %for.loop
  %18 = load i128, i128* %9, align 16
  %19 = and i128 %18, %17
  %20 = or i128 %19, %16
  store i128 %20, i128* %9, align 16
  br label %dst.addr.02.exit

dst.addr.02.case.1:                               ; preds = %for.loop
  call void @llvm.assume(i1 %12)
  %21 = load i128, i128* %10, align 16
  %22 = and i128 %21, %17
  %23 = or i128 %22, %16
  store i128 %23, i128* %10, align 16
  br label %dst.addr.02.exit
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.7.8([64 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [64 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.9.10([3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [10 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
for.loop:                                         ; preds = %dst.addr.exit, %copy
  %for.loop.idx1 = phi i64 [ 0, %copy ], [ %for.loop.idx.next, %dst.addr.exit ]
  %4 = udiv i64 %for.loop.idx1, 5
  %5 = urem i64 %for.loop.idx1, 5
  %6 = udiv i64 %5, 3
  %7 = mul i64 64, %6
  %8 = urem i64 %5, 3
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [64 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [1024 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [1024 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias readonly "orig.arg.no"="4", [64 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_03, [64 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_14, [10 x i64]* noalias readonly "orig.arg.no"="6", [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_05, [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_16) #4 {
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.3.4([64 x i256]* %_0, [64 x i256]* %_1, [256 x %struct.node_t_struct]* %0)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.5.6([1024 x i128]* %_01, [1024 x i128]* %_12, [4096 x %struct.edge_t_struct]* %1)
  call void @onebyonecpy_hls.p0a256i8.7.8([64 x i16]* align 512 %_03, [64 x i16]* align 512 %_14, [256 x i8]* %2)
  call void @onebyonecpy_hls.p0a10i64.9.10([3 x i128]* align 512 %_05, [3 x i128]* align 512 %_16, [10 x i64]* %3)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.15.16([256 x %struct.node_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.17.18([4096 x %struct.edge_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
src.addr.01.case.1:                               ; preds = %for.loop
  call void @llvm.assume(i1 %11)
  %16 = load i128, i128* %10, align 16
  %17 = lshr i128 %16, %12
  %18 = trunc i128 %17 to i64
  br label %src.addr.01.exit

src.addr.01.exit:                                 ; preds = %src.addr.01.case.1, %src.addr.01.case.0
  %19 = phi i64 [ %15, %src.addr.01.case.0 ], [ %18, %src.addr.01.case.1 ]
  store i64 %19, i64* %dst.addr.02, align 8
  %for.loop.idx.next = add nuw nsw i64 %for.loop.idx3, 1
  %exitcond = icmp ne i64 %for.loop.idx.next, 4096
  br i1 %exitcond, label %for.loop, label %ret
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.19.20([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.21.22([10 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias "orig.arg.no"="4", [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_03, [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_14, [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_05, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_16) #5 {
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.15.16([256 x %struct.node_t_struct]* %0, [64 x i256]* %_0, [64 x i256]* %_1)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.17.18([4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %_01, [1024 x i128]* %_12)
  call void @onebyonecpy_hls.p0a256i8.19.20([256 x i8]* %2, [64 x i16]* align 512 %_03, [64 x i16]* align 512 %_14)
  call void @onebyonecpy_hls.p0a10i64.21.22([10 x i64]* %3, [3 x i128]* align 512 %_05, [3 x i128]* align 512 %_16)
  ret void
}

declare void @apatb_bfs_hw([64 x i256]*, [64 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, [64 x i16]*, [64 x i16]*, [3 x i128]*, [3 x i128]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1, [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_01, [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_12, [256 x i8]* noalias "orig.arg.no"="4", [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_03, [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_14, [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_05, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_16) #5 {
entry:
  call void @onebyonecpy_hls.p0a256i8.19.20([256 x i8]* %2, [64 x i16]* align 512 %_03, [64 x i16]* align 512 %_14)
  call void @onebyonecpy_hls.p0a10i64.21.22([10 x i64]* %3, [3 x i128]* align 512 %_05, [3 x i128]* align 512 %_16)
  ret void
...
define void @bfs_hw_stub_wrapper([64 x i256]*, [64 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, [64 x i16]*, [64 x i16]*, [3 x i128]*, [3 x i128]*) #6 {
entry:
  %malloccall = tail call i8* @malloc(i64 4096)
  %9 = bitcast i8* %malloccall to [256 x %struct.node_t_struct]*
  %malloccall1 = tail call i8* @malloc(i64 32768)
  %10 = bitcast i8* %malloccall1 to [4096 x %struct.edge_t_struct]*
  %11 = alloca [256 x i8]
  %12 = alloca [10 x i64]
  call void @copy_out([256 x %struct.node_t_struct]* %9, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %10, [1024 x i128]* %2, [1024 x i128]* %3, [256 x i8]* %11, [64 x i16]* %5, [64 x i16]* %6, [10 x i64]* %12, [3 x i128]* %7, [3 x i128]* %8)
  %13 = bitcast [256 x %struct.node_t_struct]* %9 to %struct.node_t_struct*
  %14 = bitcast [4096 x %struct.edge_t_struct]* %10 to %struct.edge_t_struct*
  %15 = bitcast [256 x i8]* %11 to i8*
  %16 = bitcast [10 x i64]* %12 to i64*
  call void @bfs_hw_stub(%struct.node_t_struct* %13, %struct.edge_t_struct* %14, i64 %4, i8* %15, i64* %16)
  call void @copy_in([256 x %struct.node_t_struct]* %9, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %10, [1024 x i128]* %2, [1024 x i128]* %3, [256 x i8]* %11, [64 x i16]* %5, [64 x i16]* %6, [10 x i64]* %12, [3 x i128]* %7, [3 x i128]* %8)
  ret void
}
...
attributes #8 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="288230376151711743" }
attributes #9 = { inaccessiblememonly nounwind "xlx.port.bitwidth"="2305843009213693951" }
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_78.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
...
!40 = !DILocation(line: 7, column: 9, scope: !6)
!41 = !DILocation(line: 9, column: 9, scope: !6)
!42 = !DILocation(line: 11, column: 9, scope: !6)
