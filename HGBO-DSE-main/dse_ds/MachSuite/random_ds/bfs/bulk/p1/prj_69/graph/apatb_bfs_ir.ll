...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy8, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  %level_copy.gep9 = getelementptr [128 x i16], [128 x i16]* %level_copy8, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep9, i32 0, i32 1, i32 0) ], !dbg !41
  call void @apatb_bfs_hw([64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, i64 %starting_node, [128 x i16]* %level_copy8, i64* %8)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [64 x i256]* %nodes_copy_04, [64 x i256]* %nodes_copy_15, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_06, [1024 x i128]* %edges_copy_17, [256 x i8]* %2, [128 x i16]* %level_copy8, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.41.42([128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.11.12([256 x %struct.node_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.51.52([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a256i8.51.52([256 x i8]* %2, [128 x i16]* align 512 %3)
  call fastcc void @onebyonecpy_hls.p0a10i64([10 x i64]* %4, [10 x i64]* align 512 %5)
  ret void
}

declare void @apatb_bfs_hw([64 x i256]*, [64 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i16]*, i64*)
...
define void @bfs_hw_stub_wrapper([64 x i256]*, [64 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i16]*, i64*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %7, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %2, [1024 x i128]* %3, [256 x i8]* %9, [128 x i16]* %5, [10 x i64]* null, [10 x i64]* %10)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [64 x i256]* %0, [64 x i256]* %1, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %2, [1024 x i128]* %3, [256 x i8]* %9, [128 x i16]* %5, [10 x i64]* null, [10 x i64]* %10)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_69.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
