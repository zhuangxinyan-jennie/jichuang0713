...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy4, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  call void @apatb_bfs_hw(i128* %4, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, i64 %starting_node, [128 x i16]* %level_copy4, i64* %7)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, [256 x i8]* %2, [128 x i16]* %level_copy4, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
; Function Attrs: argmemonly noinline norecurse
define internal fastcc void @onebyonecpy_hls.p0a256struct.node_t_struct.15([256 x %struct.node_t_struct]* noalias, [256 x i128]* noalias readonly) unnamed_addr #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.32.33([128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  call fastcc void @onebyonecpy_hls.p0a256struct.node_t_struct.15([256 x %struct.node_t_struct]* %0, [256 x i128]* %1)
...
declare void @apatb_bfs_hw(i128*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i16]*, i64*)
...
define void @bfs_hw_stub_wrapper(i128*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i16]*, i64*) #6 {
entry:
  ...
  %8 = alloca [256 x i8]
  %9 = bitcast i128* %0 to [256 x i128]*
  %10 = bitcast i64* %5 to [10 x i64]*
  call void @copy_out([256 x %struct.node_t_struct]* %6, [256 x i128]* %9, [4096 x %struct.edge_t_struct]* %7, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* null, [10 x i64]* %10)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [256 x i128]* %9, [4096 x %struct.edge_t_struct]* %7, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* null, [10 x i64]* %10)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_26.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
