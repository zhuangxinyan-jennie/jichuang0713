...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* nonnull %2, [256 x i8]* nonnull align 512 %level_copy, [10 x i64]* nonnull %3, [5 x i128]* nonnull align 512 %level_counts_copy2)
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep3, i32 0, i32 1, i32 0) ], !dbg !40
  call void @apatb_bfs_hw(i128* %4, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, i64 %starting_node, i8* %7, [5 x i128]* %level_counts_copy2)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [5 x i128]* %level_counts_copy2)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.30.31([5 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [10 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a10i64.30.31([5 x i128]* align 512 %6, [10 x i64]* %5)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.36.37([10 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a10i64.36.37([10 x i64]* %5, [5 x i128]* align 512 %6)
  ret void
}

declare void @apatb_bfs_hw(i128*, [2048 x i64]*, [2048 x i64]*, i64, i8*, [5 x i128]*)
...
define void @bfs_hw_stub_wrapper(i128*, [2048 x i64]*, [2048 x i64]*, i64, i8*, [5 x i128]*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %6, [256 x i128]* %9, [4096 x %struct.edge_t_struct]* %7, [2048 x i64]* %1, [2048 x i64]* %2, [256 x i8]* null, [256 x i8]* %10, [10 x i64]* %8, [5 x i128]* %5)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [256 x i128]* %9, [4096 x %struct.edge_t_struct]* %7, [2048 x i64]* %1, [2048 x i64]* %2, [256 x i8]* null, [256 x i8]* %10, [10 x i64]* %8, [5 x i128]* %5)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_63.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
