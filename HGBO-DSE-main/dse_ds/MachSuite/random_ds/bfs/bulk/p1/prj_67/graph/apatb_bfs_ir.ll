...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* nonnull %1, [4096 x i64]* %edges_copy, [256 x i8]* nonnull %2, [64 x i16]* nonnull align 512 %level_copy_03, [64 x i16]* nonnull align 512 %level_copy_14, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  %level_copy.gep_05 = getelementptr [64 x i16], [64 x i16]* %level_copy_03, i64 0, i32 0
  %level_copy.gep_16 = getelementptr [64 x i16], [64 x i16]* %level_copy_14, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i16* %level_copy.gep_05, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i16* %level_copy.gep_16, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @apatb_bfs_hw([128 x i256]* %nodes_copy2, i64* %5, i64 %starting_node, [64 x i16]* %level_copy_03, [64 x i16]* %level_copy_14, i64* %6)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* %1, [4096 x i64]* %edges_copy, [256 x i8]* %2, [64 x i16]* %level_copy_03, [64 x i16]* %level_copy_14, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
  call void @free(i8* %malloccall)
  call void @free(i8* %malloccall1)
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep_05, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep_16, i32 0, i32 1, i32 0) ]
  ret void
}
...
declare void @apatb_bfs_hw([128 x i256]*, i64*, i64, [64 x i16]*, [64 x i16]*, i64*)
...
define void @bfs_hw_stub_wrapper([128 x i256]*, i64*, i64, [64 x i16]*, [64 x i16]*, i64*) #6 {
entry:
  ...
  %8 = alloca [256 x i8]
  %9 = bitcast i64* %1 to [4096 x i64]*
  %10 = bitcast i64* %5 to [10 x i64]*
  call void @copy_out([256 x %struct.node_t_struct]* %6, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %7, [4096 x i64]* %9, [256 x i8]* %8, [64 x i16]* %3, [64 x i16]* %4, [10 x i64]* null, [10 x i64]* %10)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %7, [4096 x i64]* %9, [256 x i8]* %8, [64 x i16]* %3, [64 x i16]* %4, [10 x i64]* null, [10 x i64]* %10)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_67.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
