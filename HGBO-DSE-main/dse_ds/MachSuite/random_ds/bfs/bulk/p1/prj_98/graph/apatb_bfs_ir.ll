...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* nonnull %1, [4096 x i64]* %edges_copy, [256 x i8]* nonnull %2, [256 x i8]* nonnull align 512 %level_copy, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  call void @apatb_bfs_hw([128 x i256]* %nodes_copy2, i64* %5, i64 %starting_node, i8* %6, i64* %7)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* %1, [4096 x i64]* %edges_copy, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [128 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [4096 x i64]* noalias "orig.arg.no"="3", [256 x i8]* noalias readonly "orig.arg.no"="4", [256 x i8]* noalias align 512 "orig.arg.no"="5", [10 x i64]* noalias readonly "orig.arg.no"="6", [10 x i64]* noalias align 512 "orig.arg.no"="7") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [4096 x i64]* noalias readonly "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [256 x i8]* noalias readonly align 512 "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [10 x i64]* noalias readonly align 512 "orig.arg.no"="7") #4 {
entry:
...
declare void @apatb_bfs_hw([128 x i256]*, i64*, i64, i8*, i64*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [4096 x i64]* noalias readonly "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [256 x i8]* noalias readonly align 512 "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [10 x i64]* noalias readonly align 512 "orig.arg.no"="7") #4 {
entry:
  call fastcc void @onebyonecpy_hls.p0a256i8([256 x i8]* %4, [256 x i8]* align 512 %5)
  call fastcc void @onebyonecpy_hls.p0a10i64([10 x i64]* %6, [10 x i64]* align 512 %7)
  ret void
...
define void @bfs_hw_stub_wrapper([128 x i256]*, i64*, i64, i8*, i64*) #5 {
entry:
  ...
  %7 = bitcast i64* %1 to [4096 x i64]*
  %8 = bitcast i8* %3 to [256 x i8]*
  %9 = bitcast i64* %4 to [10 x i64]*
  call void @copy_out([256 x %struct.node_t_struct]* %5, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %6, [4096 x i64]* %7, [256 x i8]* null, [256 x i8]* %8, [10 x i64]* null, [10 x i64]* %9)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %5, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %6, [4096 x i64]* %7, [256 x i8]* null, [256 x i8]* %8, [10 x i64]* null, [10 x i64]* %9)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_98.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
