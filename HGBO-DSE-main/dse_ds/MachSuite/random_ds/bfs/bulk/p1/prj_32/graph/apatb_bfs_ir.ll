...
entry:
  ...
  %edges_copy_03 = bitcast i8* %malloccall1_0 to [1024 x i128]*
  %malloccall1_1 = call i8* @malloc(i64 16384)
  %edges_copy_14 = bitcast i8* %malloccall1_1 to [1024 x i128]*
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_03, [1024 x i128]* %edges_copy_14, [256 x i8]* nonnull %2, [128 x i8]* nonnull align 512 %level_copy_0, [128 x i8]* nonnull align 512 %level_copy_1, [10 x i64]* nonnull %3, [5 x i128]* nonnull align 512 %level_counts_copy5)
  %4 = getelementptr [128 x i256], [128 x i256]* %nodes_copy2, i32 0, i32 0
  %5 = getelementptr [1024 x i128], [1024 x i128]* %edges_copy_03, i32 0, i32 0
  %6 = getelementptr [1024 x i128], [1024 x i128]* %edges_copy_14, i32 0, i32 0
  ...
  %level_counts_copy.gep6 = getelementptr [5 x i128], [5 x i128]* %level_counts_copy5, i64 0, i32 0
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i256* %4, i32 0, i32 1, i32 0) ], !dbg !5
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i128* %5, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  ...
  call void @apatb_bfs_hw([128 x i256]* %nodes_copy2, [1024 x i128]* %edges_copy_03, [1024 x i128]* %edges_copy_14, i64 %starting_node, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [5 x i128]* %level_counts_copy5)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_03, [1024 x i128]* %edges_copy_14, [256 x i8]* %2, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [10 x i64]* %3, [5 x i128]* %level_counts_copy5)
  call void @free(i8* %malloccall)
  call void @free(i8* %malloccall1_0)
  call void @free(i8* %malloccall1_1)
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %5, i32 0, i32 1, i32 0) ]
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.38.39([5 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [10 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [128 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [1024 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [1024 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [256 x i8]* noalias readonly "orig.arg.no"="4", [128 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_01, [128 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_12, [10 x i64]* noalias readonly "orig.arg.no"="6", [5 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7") #4 {
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct([128 x i256]* %1, [256 x %struct.node_t_struct]* %0)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.3.4([1024 x i128]* %_0, [1024 x i128]* %_1, [4096 x %struct.edge_t_struct]* %2)
  call void @onebyonecpy_hls.p0a256i8.5.6([128 x i8]* align 512 %_01, [128 x i8]* align 512 %_12, [256 x i8]* %3)
  call void @onebyonecpy_hls.p0a10i64.38.39([5 x i128]* align 512 %5, [10 x i64]* %4)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.19([256 x %struct.node_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.11.12([4096 x %struct.edge_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.48.49([10 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [256 x i8]* noalias "orig.arg.no"="4", [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_01, [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_12, [10 x i64]* noalias "orig.arg.no"="6", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7") #5 {
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.19([256 x %struct.node_t_struct]* %0, [128 x i256]* %1)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.11.12([4096 x %struct.edge_t_struct]* %2, [1024 x i128]* %_0, [1024 x i128]* %_1)
  call void @onebyonecpy_hls.p0a256i8.13.14([256 x i8]* %3, [128 x i8]* align 512 %_01, [128 x i8]* align 512 %_12)
  call void @onebyonecpy_hls.p0a10i64.48.49([10 x i64]* %4, [5 x i128]* align 512 %5)
  ret void
}

declare void @apatb_bfs_hw([128 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i8]*, [128 x i8]*, [5 x i128]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [256 x i8]* noalias "orig.arg.no"="4", [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_01, [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_12, [10 x i64]* noalias "orig.arg.no"="6", [5 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7") #5 {
entry:
  call void @onebyonecpy_hls.p0a256i8.13.14([256 x i8]* %3, [128 x i8]* align 512 %_01, [128 x i8]* align 512 %_12)
  call void @onebyonecpy_hls.p0a10i64.48.49([10 x i64]* %4, [5 x i128]* align 512 %5)
  ret void
...
define void @bfs_hw_stub_wrapper([128 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i8]*, [128 x i8]*, [5 x i128]*) #6 {
entry:
  ...
  %9 = alloca [256 x i8]
  %10 = alloca [10 x i64]
  call void @copy_out([256 x %struct.node_t_struct]* %7, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* %9, [128 x i8]* %4, [128 x i8]* %5, [10 x i64]* %10, [5 x i128]* %6)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* %9, [128 x i8]* %4, [128 x i8]* %5, [10 x i64]* %10, [5 x i128]* %6)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_32.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
