...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* nonnull %1, [4096 x i64]* %edges_copy, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy3, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  call void @apatb_bfs_hw([128 x i256]* %nodes_copy2, i64* %5, i64 %starting_node, [128 x i16]* %level_copy3, i64* %6)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* %1, [4096 x i64]* %edges_copy, [256 x i8]* %2, [128 x i16]* %level_copy3, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.12([128 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x %struct.node_t_struct]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.12([128 x i256]* %1, [256 x %struct.node_t_struct]* %0)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.27.28([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a256i8.27.28([256 x i8]* %4, [128 x i16]* align 512 %5)
  call fastcc void @onebyonecpy_hls.p0a10i64([10 x i64]* %6, [10 x i64]* align 512 %7)
  ret void
}

declare void @apatb_bfs_hw([128 x i256]*, i64*, i64, [128 x i16]*, i64*)
...
define void @bfs_hw_stub_wrapper([128 x i256]*, i64*, i64, [128 x i16]*, i64*) #5 {
entry:
  ...
  %9 = bitcast i64* %4 to [10 x i64]*
  call void @copy_out([256 x %struct.node_t_struct]* %5, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %6, [4096 x i64]* %8, [256 x i8]* %7, [128 x i16]* %3, [10 x i64]* null, [10 x i64]* %9)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %5, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %6, [4096 x i64]* %8, [256 x i8]* %7, [128 x i16]* %3, [10 x i64]* null, [10 x i64]* %9)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_59.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
