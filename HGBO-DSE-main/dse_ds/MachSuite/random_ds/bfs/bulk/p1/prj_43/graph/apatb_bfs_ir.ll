...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i128]* %edges_copy3, [256 x i8]* nonnull %2, [256 x i8]* nonnull align 512 %level_copy, [10 x i64]* nonnull %3, [3 x i128]* nonnull align 512 %level_counts_copy_04, [3 x i128]* nonnull align 512 %level_counts_copy_15)
  ...
  call void @apatb_bfs_hw([128 x i256]* %nodes_copy2, [2048 x i128]* %edges_copy3, i64 %starting_node, i8* %6, [3 x i128]* %level_counts_copy_04, [3 x i128]* %level_counts_copy_15)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* %1, [2048 x i128]* %edges_copy3, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [3 x i128]* %level_counts_copy_04, [3 x i128]* %level_counts_copy_15)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.22([2048 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [4096 x %struct.edge_t_struct]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.3.4([3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [10 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [128 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [2048 x i128]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias readonly "orig.arg.no"="4", [256 x i8]* noalias align 512 "orig.arg.no"="5", [10 x i64]* noalias readonly "orig.arg.no"="6", [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_0, [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_1) #4 {
entry:
  ...
  call void @onebyonecpy_hls.p0a10i64.3.4([3 x i128]* align 512 %_0, [3 x i128]* align 512 %_1, [10 x i64]* %6)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a10i64.9.10([10 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [256 x i8]* noalias readonly align 512 "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_0, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_1) #5 {
entry:
  ...
  call void @onebyonecpy_hls.p0a10i64.9.10([10 x i64]* %6, [3 x i128]* align 512 %_0, [3 x i128]* align 512 %_1)
  ret void
}

declare void @apatb_bfs_hw([128 x i256]*, [2048 x i128]*, i64, i8*, [3 x i128]*, [3 x i128]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3", [256 x i8]* noalias "orig.arg.no"="4", [256 x i8]* noalias readonly align 512 "orig.arg.no"="5", [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_0, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_1) #5 {
entry:
  call fastcc void @onebyonecpy_hls.p0a256i8([256 x i8]* %4, [256 x i8]* align 512 %5)
  call void @onebyonecpy_hls.p0a10i64.9.10([10 x i64]* %6, [3 x i128]* align 512 %_0, [3 x i128]* align 512 %_1)
  ret void
...
define void @bfs_hw_stub_wrapper([128 x i256]*, [2048 x i128]*, i64, i8*, [3 x i128]*, [3 x i128]*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %6, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %7, [2048 x i128]* %1, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* %8, [3 x i128]* %4, [3 x i128]* %5)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %7, [2048 x i128]* %1, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* %8, [3 x i128]* %4, [3 x i128]* %5)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_43.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
