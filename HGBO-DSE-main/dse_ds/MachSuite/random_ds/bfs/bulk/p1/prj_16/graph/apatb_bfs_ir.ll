...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i128]* %edges_copy3, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy4, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  %6 = getelementptr inbounds [10 x i64], [10 x i64]* %level_counts_copy, i32 0, i32 0
  ...
  call void @apatb_bfs_hw([128 x i256]* %nodes_copy2, [2048 x i128]* %edges_copy3, i64 %starting_node, [128 x i16]* %level_copy4, i64* %6)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* %1, [2048 x i128]* %edges_copy3, [256 x i8]* %2, [128 x i16]* %level_copy4, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.21.22([128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a256i8.21.22([128 x i16]* align 512 %5, [256 x i8]* %4)
  call fastcc void @onebyonecpy_hls.p0a10i64([10 x i64]* align 512 %7, [10 x i64]* %6)
  ret void
}

; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.6([256 x %struct.node_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.31.32([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
define void @bfs_hw_stub_wrapper([128 x i256]*, [2048 x i128]*, i64, [128 x i16]*, i64*) #5 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %5, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %6, [2048 x i128]* %1, [256 x i8]* %7, [128 x i16]* %3, [10 x i64]* null, [10 x i64]* %8)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %5, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %6, [2048 x i128]* %1, [256 x i8]* %7, [128 x i16]* %3, [10 x i64]* null, [10 x i64]* %8)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_16.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
