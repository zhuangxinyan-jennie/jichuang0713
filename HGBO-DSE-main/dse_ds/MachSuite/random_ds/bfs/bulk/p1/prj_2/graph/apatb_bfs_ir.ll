...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_03, [1024 x i128]* %edges_copy_14, [256 x i8]* nonnull %2, [128 x i16]* nonnull align 512 %level_copy5, [10 x i64]* nonnull %3, [5 x i128]* nonnull align 512 %level_counts_copy6)
  ...
  %level_copy.gep7 = getelementptr [128 x i16], [128 x i16]* %level_copy5, i64 0, i32 0
  %level_counts_copy.gep8 = getelementptr [5 x i128], [5 x i128]* %level_counts_copy6, i64 0, i32 0
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep8, i32 0, i32 1, i32 0) ], !dbg !42
  call void @apatb_bfs_hw([128 x i256]* %nodes_copy2, [1024 x i128]* %edges_copy_03, [1024 x i128]* %edges_copy_14, i64 %starting_node, [128 x i16]* %level_copy5, [5 x i128]* %level_counts_copy6)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_03, [1024 x i128]* %edges_copy_14, [256 x i8]* %2, [128 x i16]* %level_copy5, [10 x i64]* %3, [5 x i128]* %level_counts_copy6)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.34.35([128 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
entry:
  ...
  call void @onebyonecpy_hls.p0a10i64.36.37([5 x i128]* align 512 %6, [10 x i64]* %5)
  ret void
}
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.9.10([4096 x %struct.edge_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [1024 x i128]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.46.47([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
define void @bfs_hw_stub_wrapper([128 x i256]*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i16]*, [5 x i128]*) #6 {
entry:
  ...
  %8 = alloca [256 x i8]
  %9 = alloca [10 x i64]
  call void @copy_out([256 x %struct.node_t_struct]* %6, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %7, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* %9, [5 x i128]* %5)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %7, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* %8, [128 x i16]* %4, [10 x i64]* %9, [5 x i128]* %5)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_2.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
