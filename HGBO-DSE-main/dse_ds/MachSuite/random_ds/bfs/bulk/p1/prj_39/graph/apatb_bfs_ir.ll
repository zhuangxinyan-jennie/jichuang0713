...
entry:
  ...
  call void @apatb_bfs_hw(i128* %4, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, i64 %starting_node, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, i64* %7)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* %2, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
declare void @apatb_bfs_hw(i128*, [2048 x i64]*, [2048 x i64]*, i64, [128 x i8]*, [128 x i8]*, i64*)
...
define void @bfs_hw_stub_wrapper(i128*, [2048 x i64]*, [2048 x i64]*, i64, [128 x i8]*, [128 x i8]*, i64*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %7, [256 x i128]* %10, [4096 x %struct.edge_t_struct]* %8, [2048 x i64]* %1, [2048 x i64]* %2, [256 x i8]* %9, [128 x i8]* %4, [128 x i8]* %5, [10 x i64]* null, [10 x i64]* %11)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [256 x i128]* %10, [4096 x %struct.edge_t_struct]* %8, [2048 x i64]* %1, [2048 x i64]* %2, [256 x i8]* %9, [128 x i8]* %4, [128 x i8]* %5, [10 x i64]* null, [10 x i64]* %11)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_39.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
