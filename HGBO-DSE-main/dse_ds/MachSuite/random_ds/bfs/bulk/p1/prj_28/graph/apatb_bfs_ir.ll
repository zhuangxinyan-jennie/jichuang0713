...
entry:
  ...
  call void @apatb_bfs_hw([128 x i256]* %nodes_copy2, [2048 x i128]* %edges_copy3, i64 %starting_node, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, i64* %6)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* %1, [2048 x i128]* %edges_copy3, [256 x i8]* %2, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
declare void @apatb_bfs_hw([128 x i256]*, [2048 x i128]*, i64, [128 x i8]*, [128 x i8]*, i64*)
...
define void @bfs_hw_stub_wrapper([128 x i256]*, [2048 x i128]*, i64, [128 x i8]*, [128 x i8]*, i64*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %6, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %7, [2048 x i128]* %1, [256 x i8]* %8, [128 x i8]* %3, [128 x i8]* %4, [10 x i64]* null, [10 x i64]* %9)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %7, [2048 x i128]* %1, [256 x i8]* %8, [128 x i8]* %3, [128 x i8]* %4, [10 x i64]* null, [10 x i64]* %9)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_28.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
