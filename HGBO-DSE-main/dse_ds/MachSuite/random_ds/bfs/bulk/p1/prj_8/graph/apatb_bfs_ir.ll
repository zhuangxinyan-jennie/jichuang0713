...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* nonnull %2, [64 x i16]* nonnull align 512 %level_copy_03, [64 x i16]* nonnull align 512 %level_copy_14, [10 x i64]* nonnull %3, [3 x i128]* nonnull align 512 %level_counts_copy_05, [3 x i128]* nonnull align 512 %level_counts_copy_16)
  ...
  %level_copy.gep_07 = getelementptr [64 x i16], [64 x i16]* %level_copy_03, i64 0, i32 0
  %level_copy.gep_18 = getelementptr [64 x i16], [64 x i16]* %level_copy_14, i64 0, i32 0
  %level_counts_copy.gep_09 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_05, i64 0, i32 0
  %level_counts_copy.gep_110 = getelementptr [3 x i128], [3 x i128]* %level_counts_copy_16, i64 0, i32 0
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i256* %4, i32 0, i32 1, i32 0) ], !dbg !5
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i64* %5, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #0 [ "xlx_array_partition"(i64* %6, i32 0, i32 1, i32 0, i1 false) ], !dbg !40
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i16* %level_copy.gep_07, i32 0, i32 1, i32 0, i1 false) ], !dbg !41
  call void @llvm.sideeffect() #7 [ "xlx_array_partition"(i16* %level_copy.gep_18, i32 0, i32 1, i32 0, i1 false) ], !dbg !41
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %level_counts_copy.gep_09, i32 0, i32 1, i32 0, i1 false) ], !dbg !42
  call void @llvm.sideeffect() #8 [ "xlx_array_partition"(i128* %level_counts_copy.gep_110, i32 0, i32 1, i32 0, i1 false) ], !dbg !42
  call void @apatb_bfs_hw([128 x i256]* %nodes_copy2, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, i64 %starting_node, [64 x i16]* %level_copy_03, [64 x i16]* %level_copy_14, [3 x i128]* %level_counts_copy_05, [3 x i128]* %level_counts_copy_16)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i256]* %nodes_copy2, [4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* %2, [64 x i16]* %level_copy_03, [64 x i16]* %level_copy_14, [10 x i64]* %3, [3 x i128]* %level_counts_copy_05, [3 x i128]* %level_counts_copy_16)
  call void @free(i8* %malloccall)
  call void @free(i8* %malloccall1_0)
  call void @free(i8* %malloccall1_1)
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep_07, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i16* %level_copy.gep_18, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep_09, i32 0, i32 1, i32 0) ]
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep_110, i32 0, i32 1, i32 0) ]
  ret void
}
...
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.3.4([2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [4096 x %struct.edge_t_struct]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a4096struct.edge_t_struct.13.14([4096 x %struct.edge_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.5.6([64 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [64 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_in([256 x %struct.node_t_struct]* noalias readonly "orig.arg.no"="0", [128 x i256]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias readonly "orig.arg.no"="2", [2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [2048 x i64]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [256 x i8]* noalias readonly "orig.arg.no"="4", [64 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_01, [64 x i16]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_12, [10 x i64]* noalias readonly "orig.arg.no"="6", [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #4 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256struct.node_t_struct.33([256 x %struct.node_t_struct]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.15.16([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #3 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @copy_out([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [256 x i8]* noalias "orig.arg.no"="4", [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_01, [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_12, [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #5 {
entry:
  call void @onebyonecpy_hls.p0a256struct.node_t_struct.33([256 x %struct.node_t_struct]* %0, [128 x i256]* %1)
  call void @onebyonecpy_hls.p0a4096struct.edge_t_struct.13.14([4096 x %struct.edge_t_struct]* %2, [2048 x i64]* %_0, [2048 x i64]* %_1)
...
declare void @apatb_bfs_hw([128 x i256]*, [2048 x i64]*, [2048 x i64]*, i64, [64 x i16]*, [64 x i16]*, [3 x i128]*, [3 x i128]*)

; Function Attrs: argmemonly noinline norecurse
define internal void @copy_back([256 x %struct.node_t_struct]* noalias "orig.arg.no"="0", [128 x i256]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1", [4096 x %struct.edge_t_struct]* noalias "orig.arg.no"="2", [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_0, [2048 x i64]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="3" %_1, [256 x i8]* noalias "orig.arg.no"="4", [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_01, [64 x i16]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="5" %_12, [10 x i64]* noalias "orig.arg.no"="6", [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_03, [3 x i128]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="7" %_14) #5 {
entry:
  call void @onebyonecpy_hls.p0a256i8.15.16([256 x i8]* %3, [64 x i16]* align 512 %_01, [64 x i16]* align 512 %_12)
  call void @onebyonecpy_hls.p0a10i64.17.18([10 x i64]* %4, [3 x i128]* align 512 %_03, [3 x i128]* align 512 %_14)
  ret void
...
define void @bfs_hw_stub_wrapper([128 x i256]*, [2048 x i64]*, [2048 x i64]*, i64, [64 x i16]*, [64 x i16]*, [3 x i128]*, [3 x i128]*) #6 {
entry:
  ...
  %10 = alloca [256 x i8]
  %11 = alloca [10 x i64]
  call void @copy_out([256 x %struct.node_t_struct]* %8, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %9, [2048 x i64]* %1, [2048 x i64]* %2, [256 x i8]* %10, [64 x i16]* %4, [64 x i16]* %5, [10 x i64]* %11, [3 x i128]* %6, [3 x i128]* %7)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %8, [128 x i256]* %0, [4096 x %struct.edge_t_struct]* %9, [2048 x i64]* %1, [2048 x i64]* %2, [256 x i8]* %10, [64 x i16]* %4, [64 x i16]* %5, [10 x i64]* %11, [3 x i128]* %6, [3 x i128]* %7)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_8.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
...
!41 = !DILocation(line: 5, column: 9, scope: !6)
