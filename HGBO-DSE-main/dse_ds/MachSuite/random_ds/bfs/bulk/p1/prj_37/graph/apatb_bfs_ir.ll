...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i128]* %edges_copy2, [256 x i8]* nonnull %2, [256 x i8]* nonnull align 512 %level_copy, [10 x i64]* nonnull %3, [5 x i128]* nonnull align 512 %level_counts_copy3)
  ...
  call void @llvm.sideeffect() #0 [ "xlx_array_reshape"(i128* %level_counts_copy.gep4, i32 0, i32 1, i32 0) ], !dbg !40
  call void @apatb_bfs_hw(i128* %4, [2048 x i128]* %edges_copy2, i64 %starting_node, i8* %6, [5 x i128]* %level_counts_copy3)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [2048 x i128]* %edges_copy2, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [5 x i128]* %level_counts_copy3)
...
declare void @apatb_bfs_hw(i128*, [2048 x i128]*, i64, i8*, [5 x i128]*)
...
define void @bfs_hw_stub_wrapper(i128*, [2048 x i128]*, i64, i8*, [5 x i128]*) #5 {
entry:
  ...
  %7 = alloca [10 x i64]
  %8 = bitcast i128* %0 to [256 x i128]*
  %9 = bitcast i8* %3 to [256 x i8]*
  call void @copy_out([256 x %struct.node_t_struct]* %5, [256 x i128]* %8, [4096 x %struct.edge_t_struct]* %6, [2048 x i128]* %1, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* %7, [5 x i128]* %4)
  ...
  %13 = bitcast [10 x i64]* %7 to i64*
  call void @bfs_hw_stub(%struct.node_t_struct* %10, %struct.edge_t_struct* %11, i64 %2, i8* %12, i64* %13)
  call void @copy_in([256 x %struct.node_t_struct]* %5, [256 x i128]* %8, [4096 x %struct.edge_t_struct]* %6, [2048 x i128]* %1, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* %7, [5 x i128]* %4)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_37.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
