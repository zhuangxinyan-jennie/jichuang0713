...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* nonnull %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* nonnull %2, [256 x i8]* nonnull align 512 %level_copy, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  call void @apatb_bfs_hw(i128* %4, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, i64 %starting_node, i8* %7, i64* %8)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [2048 x i64]* %edges_copy_0, [2048 x i64]* %edges_copy_1, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
declare void @apatb_bfs_hw(i128*, [2048 x i64]*, [2048 x i64]*, i64, i8*, i64*)
...
define void @bfs_hw_stub_wrapper(i128*, [2048 x i64]*, [2048 x i64]*, i64, i8*, i64*) #6 {
entry:
  ...
  call void @copy_out([256 x %struct.node_t_struct]* %6, [256 x i128]* %8, [4096 x %struct.edge_t_struct]* %7, [2048 x i64]* %1, [2048 x i64]* %2, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* null, [10 x i64]* %10)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %6, [256 x i128]* %8, [4096 x %struct.edge_t_struct]* %7, [2048 x i64]* %1, [2048 x i64]* %2, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* null, [10 x i64]* %10)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_42.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
