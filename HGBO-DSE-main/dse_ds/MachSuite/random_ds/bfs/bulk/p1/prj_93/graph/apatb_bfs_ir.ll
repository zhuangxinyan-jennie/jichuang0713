...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, [256 x i8]* nonnull %2, [128 x i8]* nonnull align 512 %level_copy_0, [128 x i8]* nonnull align 512 %level_copy_1, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  call void @apatb_bfs_hw(i128* %4, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, i64 %starting_node, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, i64* %7)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [256 x i128]* %nodes_copy, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_02, [1024 x i128]* %edges_copy_13, [256 x i8]* %2, [128 x i8]* %level_copy_0, [128 x i8]* %level_copy_1, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.5.6([128 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_0, [128 x i8]* noalias align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0" %_1, [256 x i8]* noalias readonly "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1") #2 {
entry:
...
; Function Attrs: argmemonly noinline norecurse
define internal void @onebyonecpy_hls.p0a256i8.13.14([256 x i8]* noalias "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="0", [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_0, [128 x i8]* noalias readonly align 512 "fpga.caller.interfaces"="layout_transformed" "orig.arg.no"="1" %_1) #2 {
entry:
...
declare void @apatb_bfs_hw(i128*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i8]*, [128 x i8]*, i64*)
...
define void @bfs_hw_stub_wrapper(i128*, [1024 x i128]*, [1024 x i128]*, i64, [128 x i8]*, [128 x i8]*, i64*) #6 {
entry:
  ...
  %11 = bitcast i64* %6 to [10 x i64]*
  call void @copy_out([256 x %struct.node_t_struct]* %7, [256 x i128]* %10, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* %9, [128 x i8]* %4, [128 x i8]* %5, [10 x i64]* null, [10 x i64]* %11)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [256 x i128]* %10, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %1, [1024 x i128]* %2, [256 x i8]* %9, [128 x i8]* %4, [128 x i8]* %5, [10 x i64]* null, [10 x i64]* %11)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_93.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
