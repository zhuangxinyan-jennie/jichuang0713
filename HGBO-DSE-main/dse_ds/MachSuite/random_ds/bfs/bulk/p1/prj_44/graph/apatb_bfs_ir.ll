...
entry:
  ...
  call void @copy_in([256 x %struct.node_t_struct]* nonnull %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* nonnull %1, [1024 x i128]* %edges_copy_04, [1024 x i128]* %edges_copy_15, [256 x i8]* nonnull %2, [256 x i8]* nonnull align 512 %level_copy, [10 x i64]* nonnull %3, [10 x i64]* nonnull align 512 %level_counts_copy)
  ...
  %9 = getelementptr inbounds [10 x i64], [10 x i64]* %level_counts_copy, i32 0, i32 0
  ...
  call void @apatb_bfs_hw([128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [1024 x i128]* %edges_copy_04, [1024 x i128]* %edges_copy_15, i64 %starting_node, i8* %8, i64* %9)
  call void @copy_back([256 x %struct.node_t_struct]* %0, [128 x i128]* %nodes_copy_0, [128 x i128]* %nodes_copy_1, [4096 x %struct.edge_t_struct]* %1, [1024 x i128]* %edges_copy_04, [1024 x i128]* %edges_copy_15, [256 x i8]* %2, [256 x i8]* %level_copy, [10 x i64]* %3, [10 x i64]* %level_counts_copy)
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a10i64([10 x i64]* align 512 %5, [10 x i64]* %4)
  ret void
}
...
entry:
  ...
  call fastcc void @onebyonecpy_hls.p0a10i64([10 x i64]* %4, [10 x i64]* align 512 %5)
  ret void
}

declare void @apatb_bfs_hw([128 x i128]*, [128 x i128]*, [1024 x i128]*, [1024 x i128]*, i64, i8*, i64*)
...
define void @bfs_hw_stub_wrapper([128 x i128]*, [128 x i128]*, [1024 x i128]*, [1024 x i128]*, i64, i8*, i64*) #6 {
entry:
  ...
  %9 = bitcast i8* %5 to [256 x i8]*
  %10 = bitcast i64* %6 to [10 x i64]*
  call void @copy_out([256 x %struct.node_t_struct]* %7, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %2, [1024 x i128]* %3, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* null, [10 x i64]* %10)
  ...
  call void @copy_in([256 x %struct.node_t_struct]* %7, [128 x i128]* %0, [128 x i128]* %1, [4096 x %struct.edge_t_struct]* %8, [1024 x i128]* %2, [1024 x i128]* %3, [256 x i8]* null, [256 x i8]* %9, [10 x i64]* null, [10 x i64]* %10)
  ret void
}
...
!7 = !DIFile(filename: "/home/noel/Documents/HGBO-DSE-main/dse_ds/MachSuite/random_ds/bfs/bulk/p1/script/dir_44.tcl", directory: "/home/noel/Documents/HGBO-DSE-main/benchmark/MachSuite/bfs/bulk")
